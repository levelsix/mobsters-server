...
public class PvpBoardObstacleForUserRetrieveUtil {

	private static Logger log = LoggerFactory.getLogger(PvpBoardObstacleForUserRetrieveUtil.class);
	...
	public List<PvpBoardObstacleForUser> getPvpBoardObstacleForUserId(
			String userId) {
	...
	public Map<String, List<PvpBoardObstacleForUser>> getPvpBoardObstacleForUserIds(
		...
		Map<String, List<PvpBoardObstacleForUser>> userIdToPvpBoardObstacles = new HashMap<String, List<PvpBoardObstacleForUser>>();
		try {
	...
	private static final class UserBoardObstacleForClientMapper implements
			RowMapper<PvpBoardObstacleForUser> {

		private static List<String> columnsSelected;

		@Override
		public PvpBoardObstacleForUser mapRow(ResultSet rs, int rowNum)
				throws SQLException {
			...
			pbofu.setUserId(rs
					.getString(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__USER_ID));
			pbofu.setObstacleId(rs
					.getInt(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__OBSTACLE_ID));
			pbofu.setPosX(rs
					.getInt(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__POS_X));
			pbofu.setPosY(rs
					.getInt(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__POS_Y));
		...
		public static List<String> getColumnsSelected() {
			if (null == columnsSelected) {
				...
				columnsSelected
						.add(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__ID);
				columnsSelected
						.add(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__USER_ID);
				columnsSelected
						.add(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__OBSTACLE_ID);
				columnsSelected
						.add(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__POS_X);
				columnsSelected
						.add(DBConstants.PVP_BOARD_OBSTACLE_FOR_USER__POS_Y);
			}
