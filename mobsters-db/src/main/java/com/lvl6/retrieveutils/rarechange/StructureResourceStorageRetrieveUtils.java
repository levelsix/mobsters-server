...
public class StructureResourceStorageRetrieveUtils {

	private static Logger log = LoggerFactory.getLogger(StructureResourceStorageRetrieveUtils.class);
	...
	public StructureResourceStorage getUpgradedResourceStorageForStructId(
		...
		if (null != curStruct) {
			...
			StructureResourceStorage upgradedStruct = structIdsToResourceStorages
	...
	public StructureResourceStorage getPredecessorResourceStorageForStructId(
		...
		if (null != curStruct) {
			...
			StructureResourceStorage predecessorStruct = structIdsToResourceStorages
	...
	private StructureResourceStorage convertRSRowToResourceStorage(
		...
		String resourceTypeStored = rs
				.getString(DBConstants.STRUCTURE_RESOURCE_STORAGE__RESOURCE_TYPE_STORED);
		int capacity = rs
				.getInt(DBConstants.STRUCTURE_RESOURCE_STORAGE__CAPACITY);
