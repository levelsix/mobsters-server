...
public class StructureEvoChamberRetrieveUtils {

	private static Logger log = LoggerFactory.getLogger(StructureEvoChamberRetrieveUtils.class);
	...
	public StructureEvoChamber getUpgradedEvoChamberForStructId(
		...
		if (null != curStruct) {
			...
			StructureEvoChamber upgradedStruct = structIdsToEvoChambers
	...
	public StructureEvoChamber getPredecessorEvoChamberForStructId(
		...
		if (null != curStruct) {
			...
			StructureEvoChamber predecessorStruct = structIdsToEvoChambers
	...
	private StructureEvoChamber convertRSRowToEvoChamber(ResultSet rs)
		...
		String qualityUnlocked = rs
				.getString(DBConstants.STRUCTURE_EVO__QUALITY_UNLOCKED);
		int evoTierUnlocked = rs
				.getInt(DBConstants.STRUCTURE_EVO__EVO_TIER_UNLOCKED);
		...
		return new StructureEvoChamber(structId, qualityUnlocked,
				evoTierUnlocked);
	}
}
