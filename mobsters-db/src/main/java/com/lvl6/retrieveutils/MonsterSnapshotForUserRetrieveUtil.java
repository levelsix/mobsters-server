...
public class MonsterSnapshotForUserRetrieveUtil {
	...
	public List<MonsterSnapshotForUser> getMonstersSnapshots(String type,
			Collection<String> idsInTable) {
		List<MonsterSnapshotForUser> userMonstersSnapshots = null;
		log.debug("retrieving user monsters for type={}, idsInTable={}", type,
				idsInTable);

		try {
			int numQuestionMarks = idsInTable.size();
			List<String> questionMarkList = Collections.nCopies(
					numQuestionMarks, "?");
			...
			userMonstersSnapshots = this.jdbcTemplate.query(query,
					valuesList.toArray(), rowMapper);
		} catch (Exception e) {
	...
	public List<MonsterSnapshotForUser> getMonstersSnapshots(String type,
			String idInTable) {
		log.debug("retrieving user monsters for type={}, idInTable={}", type,
				idInTable);
		...
		List<MonsterSnapshotForUser> userMonstersSnapshots = null;
		try {
			userMonstersSnapshots = this.jdbcTemplate.query(query, values,
					rowMapper);
		} catch (Exception e) {
			log.error("MonsterSnapshotForUser retrieve db error.", e);
			//		} finally {
	...
	*/
	...
	private static final class UserMonsterSnapshotForClientMapper implements
			RowMapper<MonsterSnapshotForUser> {

		private static List<String> columnsSelected;
		private static String columnsSelectedStr;

		@Override
		public MonsterSnapshotForUser mapRow(ResultSet rs, int rowNum)
				throws SQLException {
			MonsterSnapshotForUser msfu = new MonsterSnapshotForUser();
			msfu.setId(rs.getString(DBConstants.MONSTER_SNAPSHOT_FOR_USER__ID));
			try {
				Timestamp time = rs
						.getTimestamp(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TIME_OF_ENTRY);
			...
			msfu.setUserId(rs
					.getString(DBConstants.MONSTER_SNAPSHOT_FOR_USER__USER_ID));
			msfu.setType(rs
					.getString(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TYPE));
			msfu.setIdInTable(rs
					.getString(DBConstants.MONSTER_SNAPSHOT_FOR_USER__ID_IN_TABLE));
			msfu.setMonsterForUserId(rs
					.getString(DBConstants.MONSTER_SNAPSHOT_FOR_USER__MONSTER_FOR_USER_ID));
			msfu.setMonsterId(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__MONSTER_ID));
			msfu.setCurrentExp(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_EXP));
			msfu.setCurrentLvl(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_LVL));
			msfu.setCurrentHp(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_HP));
			msfu.setTeamSlotNum(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TEAM_SLOT_NUM));
			msfu.setOffSkillId(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__OFF_SKILL_ID));
			msfu.setDefSkillId(rs
					.getInt(DBConstants.MONSTER_SNAPSHOT_FOR_USER__DEF_SKILL_ID));
		...
		public static List<String> getColumnsSelected() {
			if (null == columnsSelected) {
				...
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TIME_OF_ENTRY);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__USER_ID);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TYPE);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__ID_IN_TABLE);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__MONSTER_FOR_USER_ID);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__MONSTER_ID);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_EXP);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_LVL);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__CURRENT_HP);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__TEAM_SLOT_NUM);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__OFF_SKILL_ID);
				columnsSelected
						.add(DBConstants.MONSTER_SNAPSHOT_FOR_USER__DEF_SKILL_ID);
			}
