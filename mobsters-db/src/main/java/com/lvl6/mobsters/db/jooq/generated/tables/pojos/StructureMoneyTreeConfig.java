...
public class StructureMoneyTreeConfig implements IStructureMoneyTreeConfig {

	private static final long serialVersionUID = 837543772;
	...
	public StructureMoneyTreeConfig(StructureMoneyTreeConfig value) {
	...
	@Override
	public StructureMoneyTreeConfig setStructId(Integer structId) {
		this.structId = structId;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setProductionRate(Double productionRate) {
		this.productionRate = productionRate;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setCapacity(Integer capacity) {
		this.capacity = capacity;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setDaysOfDuration(Integer daysOfDuration) {
		this.daysOfDuration = daysOfDuration;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setDaysForRenewal(Integer daysForRenewal) {
		this.daysForRenewal = daysForRenewal;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setIapProductId(String iapProductId) {
		this.iapProductId = iapProductId;
		return this;
	}
	...
	@Override
	public StructureMoneyTreeConfig setFakeIapProductId(String fakeIapProductId) {
		this.fakeIapProductId = fakeIapProductId;
		return this;
	}
