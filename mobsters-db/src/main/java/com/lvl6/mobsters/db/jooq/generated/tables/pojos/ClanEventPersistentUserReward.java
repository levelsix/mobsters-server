...
public class ClanEventPersistentUserReward implements IClanEventPersistentUserReward {

	private static final long serialVersionUID = -671859584;
	...
	public ClanEventPersistentUserReward(ClanEventPersistentUserReward value) {
		this.id = value.id;
	...
	@Override
	public ClanEventPersistentUserReward setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setCrsStartTime(Timestamp crsStartTime) {
		this.crsStartTime = crsStartTime;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setCrsId(Integer crsId) {
		this.crsId = crsId;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setCrsEndTime(Timestamp crsEndTime) {
		this.crsEndTime = crsEndTime;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setResourceType(String resourceType) {
		this.resourceType = resourceType;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setStaticDataId(Integer staticDataId) {
		this.staticDataId = staticDataId;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setQuantity(Integer quantity) {
		this.quantity = quantity;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setClanEventPersistentId(Integer clanEventPersistentId) {
		this.clanEventPersistentId = clanEventPersistentId;
		return this;
	}
	...
	@Override
	public ClanEventPersistentUserReward setTimeRedeemed(Timestamp timeRedeemed) {
		this.timeRedeemed = timeRedeemed;
		return this;
	}
