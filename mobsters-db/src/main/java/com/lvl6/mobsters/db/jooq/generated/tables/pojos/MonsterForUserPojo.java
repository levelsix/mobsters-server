...
public class MonsterForUserPojo implements IMonsterForUser {

	private static final long serialVersionUID = 1504191433;
	...
	public MonsterForUserPojo() {}

	public MonsterForUserPojo(MonsterForUserPojo value) {
		this.id = value.id;
	...
	@Override
	public MonsterForUserPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setMonsterId(Integer monsterId) {
		this.monsterId = monsterId;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setCurrentExperience(Integer currentExperience) {
		this.currentExperience = currentExperience;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setCurrentLevel(Byte currentLevel) {
		this.currentLevel = currentLevel;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setCurrentHealth(Integer currentHealth) {
		this.currentHealth = currentHealth;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setNumPieces(Byte numPieces) {
		this.numPieces = numPieces;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setIsComplete(Boolean isComplete) {
		this.isComplete = isComplete;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setCombineStartTime(Timestamp combineStartTime) {
		this.combineStartTime = combineStartTime;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setTeamSlotNum(Byte teamSlotNum) {
		this.teamSlotNum = teamSlotNum;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setSourceOfPieces(String sourceOfPieces) {
		this.sourceOfPieces = sourceOfPieces;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setHasAllPieces(Boolean hasAllPieces) {
		this.hasAllPieces = hasAllPieces;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setRestricted(Boolean restricted) {
		this.restricted = restricted;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setOffensiveSkillId(Integer offensiveSkillId) {
		this.offensiveSkillId = offensiveSkillId;
		return this;
	}
	...
	@Override
	public MonsterForUserPojo setDefensiveSkillId(Integer defensiveSkillId) {
		this.defensiveSkillId = defensiveSkillId;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.MonsterForUserRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.MonsterForUserRecord();
		poop.from(this);
		return "MonsterForUserPojo[" + poop.valuesRow() + "]";
	}
}
