...
public class ResearchConfig implements IResearchConfig {

	private static final long serialVersionUID = -491193480;
	...
	public ResearchConfig(ResearchConfig value) {
		this.id = value.id;
	...
	@Override
	public ResearchConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ResearchConfig setResearchType(String researchType) {
		this.researchType = researchType;
		return this;
	}
	...
	@Override
	public ResearchConfig setResearchDomain(String researchDomain) {
		this.researchDomain = researchDomain;
		return this;
	}
	...
	@Override
	public ResearchConfig setIconImgName(String iconImgName) {
		this.iconImgName = iconImgName;
		return this;
	}
	...
	@Override
	public ResearchConfig setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public ResearchConfig setPredId(Integer predId) {
		this.predId = predId;
		return this;
	}
	...
	@Override
	public ResearchConfig setSuccId(Integer succId) {
		this.succId = succId;
		return this;
	}
	...
	@Override
	public ResearchConfig setDesc(String desc) {
		this.desc = desc;
		return this;
	}
	...
	@Override
	public ResearchConfig setDurationMin(Integer durationMin) {
		this.durationMin = durationMin;
		return this;
	}
	...
	@Override
	public ResearchConfig setCostAmt(Integer costAmt) {
		this.costAmt = costAmt;
		return this;
	}
	...
	@Override
	public ResearchConfig setCostType(String costType) {
		this.costType = costType;
		return this;
	}
	...
	@Override
	public ResearchConfig setLevel(Integer level) {
		this.level = level;
		return this;
	}
	...
	@Override
	public ResearchConfig setPriority(Double priority) {
		this.priority = priority;
		return this;
	}
	...
	@Override
	public ResearchConfig setTier(Integer tier) {
		this.tier = tier;
		return this;
	}
	...
	@Override
	public ResearchConfig setStrength(Integer strength) {
		this.strength = strength;
		return this;
	}
