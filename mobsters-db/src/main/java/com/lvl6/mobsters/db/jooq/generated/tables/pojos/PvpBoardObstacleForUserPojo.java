...
public class PvpBoardObstacleForUserPojo implements IPvpBoardObstacleForUser {
	...
	public PvpBoardObstacleForUserPojo() {}

	public PvpBoardObstacleForUserPojo(PvpBoardObstacleForUserPojo value) {
	...
	@Override
	public PvpBoardObstacleForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public PvpBoardObstacleForUserPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public PvpBoardObstacleForUserPojo setObstacleId(Integer obstacleId) {
		this.obstacleId = obstacleId;
		return this;
	}
	...
	@Override
	public PvpBoardObstacleForUserPojo setPosX(Integer posX) {
		this.posX = posX;
		return this;
	}
	...
	@Override
	public PvpBoardObstacleForUserPojo setPosY(Integer posY) {
		this.posY = posY;
		return this;
	}
