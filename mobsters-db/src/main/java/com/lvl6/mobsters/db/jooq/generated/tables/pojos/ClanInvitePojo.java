...
public class ClanInvitePojo implements IClanInvite {

	private static final long serialVersionUID = -1613241508;
	...
	public ClanInvitePojo() {}

	public ClanInvitePojo(ClanInvitePojo value) {
		this.id = value.id;
	...
	@Override
	public ClanInvitePojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanInvitePojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ClanInvitePojo setInviterId(String inviterId) {
		this.inviterId = inviterId;
		return this;
	}
	...
	@Override
	public ClanInvitePojo setClanId(String clanId) {
		this.clanId = clanId;
		return this;
	}
	...
	@Override
	public ClanInvitePojo setTimeOfInvite(Timestamp timeOfInvite) {
		this.timeOfInvite = timeOfInvite;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.ClanInviteRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.ClanInviteRecord();
		poop.from(this);
		return "ClanInvitePojo[" + poop.valuesRow() + "]";
	}
}
