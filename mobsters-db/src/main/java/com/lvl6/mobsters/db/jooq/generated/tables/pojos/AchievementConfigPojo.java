...
public class AchievementConfigPojo implements IAchievementConfig {
	...
	public AchievementConfigPojo() {}

	public AchievementConfigPojo(AchievementConfigPojo value) {
		this.id = value.id;
	...
	@Override
	public AchievementConfigPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setDescription(String description) {
		this.description = description;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setGemReward(Integer gemReward) {
		this.gemReward = gemReward;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setLvl(Byte lvl) {
		this.lvl = lvl;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setAchievementType(String achievementType) {
		this.achievementType = achievementType;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setResourceType(String resourceType) {
		this.resourceType = resourceType;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setMonsterElement(String monsterElement) {
		this.monsterElement = monsterElement;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setMonsterQuality(String monsterQuality) {
		this.monsterQuality = monsterQuality;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setStaticDataId(Integer staticDataId) {
		this.staticDataId = staticDataId;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setQuantity(Integer quantity) {
		this.quantity = quantity;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setPriority(Integer priority) {
		this.priority = priority;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setPrerequisiteId(Integer prerequisiteId) {
		this.prerequisiteId = prerequisiteId;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setSuccessorId(Integer successorId) {
		this.successorId = successorId;
		return this;
	}
	...
	@Override
	public AchievementConfigPojo setExpReward(Integer expReward) {
		this.expReward = expReward;
		return this;
	}
