...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.PvpBoardObstacleForUserPojo;
...
public class PvpBoardObstacleForUserDao extends DAOImpl<PvpBoardObstacleForUserRecord, PvpBoardObstacleForUserPojo, Record2<String, Integer>> {

	/**
	 * Create a new PvpBoardObstacleForUserDao without any configuration
	 */
	public PvpBoardObstacleForUserDao() {
		super(PvpBoardObstacleForUser.PVP_BOARD_OBSTACLE_FOR_USER, PvpBoardObstacleForUserPojo.class);
	}
	...
	public PvpBoardObstacleForUserDao(Configuration configuration) {
		super(PvpBoardObstacleForUser.PVP_BOARD_OBSTACLE_FOR_USER, PvpBoardObstacleForUserPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Record2<String, Integer> getId(PvpBoardObstacleForUserPojo object) {
	 ...
	 */
	public List<PvpBoardObstacleForUserPojo> fetchByUserId(String... values) {
	 ...
	 */
	public List<PvpBoardObstacleForUserPojo> fetchById(Integer... values) {
	 ...
	 */
	public List<PvpBoardObstacleForUserPojo> fetchByObstacleId(Integer... values) {
	 ...
	 */
	public List<PvpBoardObstacleForUserPojo> fetchByPosX(Integer... values) {
	 ...
	 */
	public List<PvpBoardObstacleForUserPojo> fetchByPosY(Integer... values) {
