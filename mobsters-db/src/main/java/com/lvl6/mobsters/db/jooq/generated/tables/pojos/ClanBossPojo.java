...
public class ClanBossPojo implements IClanBoss {

	private static final long serialVersionUID = 1241460776;
	...
	public ClanBossPojo(ClanBossPojo value) {
		this.id = value.id;
	...
	@Override
	public ClanBossPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanBossPojo setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public ClanBossPojo setHp(Integer hp) {
		this.hp = hp;
		return this;
	}
	...
	@Override
	public ClanBossPojo setEnergyCost(Integer energyCost) {
		this.energyCost = energyCost;
		return this;
	}
	...
	@Override
	public ClanBossPojo setMinutesToKill(Integer minutesToKill) {
		this.minutesToKill = minutesToKill;
		return this;
	}
	...
	@Override
	public ClanBossPojo setMinutesToRespawn(Integer minutesToRespawn) {
		this.minutesToRespawn = minutesToRespawn;
		return this;
	}
	...
	@Override
	public ClanBossPojo setNumRunesOne(Integer numRunesOne) {
		this.numRunesOne = numRunesOne;
		return this;
	}
	...
	@Override
	public ClanBossPojo setNumRunesTwo(Integer numRunesTwo) {
		this.numRunesTwo = numRunesTwo;
		return this;
	}
	...
	@Override
	public ClanBossPojo setNumRunesThree(Integer numRunesThree) {
		this.numRunesThree = numRunesThree;
		return this;
	}
	...
	@Override
	public ClanBossPojo setNumRunesFour(Integer numRunesFour) {
		this.numRunesFour = numRunesFour;
		return this;
	}
	...
	@Override
	public ClanBossPojo setNumRunesFive(Integer numRunesFive) {
		this.numRunesFive = numRunesFive;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.ClanBossRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.ClanBossRecord();
		poop.from(this);
		return "ClanBossPojo[" + poop.valuesRow() + "]";
	}
}
