...
public class MiniEventForUser implements IMiniEventForUser {

	private static final long serialVersionUID = 33503400;
	...
	public MiniEventForUser(MiniEventForUser value) {
	...
	@Override
	public MiniEventForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MiniEventForUser setMiniEventId(Integer miniEventId) {
		this.miniEventId = miniEventId;
		return this;
	}
	...
	@Override
	public MiniEventForUser setUserLvl(Integer userLvl) {
		this.userLvl = userLvl;
		return this;
	}
	...
	@Override
	public MiniEventForUser setTierOneRedeemed(Boolean tierOneRedeemed) {
		this.tierOneRedeemed = tierOneRedeemed;
		return this;
	}
	...
	@Override
	public MiniEventForUser setTierTwoRedeemed(Boolean tierTwoRedeemed) {
		this.tierTwoRedeemed = tierTwoRedeemed;
		return this;
	}
	...
	@Override
	public MiniEventForUser setTierThreeRedeemed(Boolean tierThreeRedeemed) {
		this.tierThreeRedeemed = tierThreeRedeemed;
		return this;
	}
