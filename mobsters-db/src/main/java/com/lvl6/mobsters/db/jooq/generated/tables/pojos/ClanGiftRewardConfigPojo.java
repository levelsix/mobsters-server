...
public class ClanGiftRewardConfigPojo implements IClanGiftRewardConfig {

	private static final long serialVersionUID = 535965812;
	...
	public ClanGiftRewardConfigPojo() {}

	public ClanGiftRewardConfigPojo(ClanGiftRewardConfigPojo value) {
		this.id = value.id;
	...
	@Override
	public ClanGiftRewardConfigPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanGiftRewardConfigPojo setClanGiftId(Integer clanGiftId) {
		this.clanGiftId = clanGiftId;
		return this;
	}
	...
	@Override
	public ClanGiftRewardConfigPojo setRewardId(Integer rewardId) {
		this.rewardId = rewardId;
		return this;
	}
	...
	@Override
	public ClanGiftRewardConfigPojo setChanceOfDrop(Double chanceOfDrop) {
		this.chanceOfDrop = chanceOfDrop;
		return this;
	}
