...
public class ObstacleForUser implements IObstacleForUser {

	private static final long serialVersionUID = 811217981;
	...
	public ObstacleForUser(ObstacleForUser value) {
		this.id = value.id;
	...
	@Override
	public ObstacleForUser setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ObstacleForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ObstacleForUser setObstacleId(Integer obstacleId) {
		this.obstacleId = obstacleId;
		return this;
	}
	...
	@Override
	public ObstacleForUser setXcoord(Integer xcoord) {
		this.xcoord = xcoord;
		return this;
	}
	...
	@Override
	public ObstacleForUser setYcoord(Integer ycoord) {
		this.ycoord = ycoord;
		return this;
	}
	...
	@Override
	public ObstacleForUser setRemovalTime(Timestamp removalTime) {
		this.removalTime = removalTime;
		return this;
	}
	...
	@Override
	public ObstacleForUser setOrientation(String orientation) {
		this.orientation = orientation;
		return this;
	}
