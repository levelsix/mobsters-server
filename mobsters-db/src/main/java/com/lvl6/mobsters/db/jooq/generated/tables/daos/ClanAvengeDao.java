...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.ClanAvengePojo;
...
public class ClanAvengeDao extends DAOImpl<ClanAvengeRecord, ClanAvengePojo, String> {

	/**
	 * Create a new ClanAvengeDao without any configuration
	 */
	public ClanAvengeDao() {
		super(ClanAvenge.CLAN_AVENGE, ClanAvengePojo.class);
	}
	...
	public ClanAvengeDao(Configuration configuration) {
		super(ClanAvenge.CLAN_AVENGE, ClanAvengePojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected String getId(ClanAvengePojo object) {
		return object.getId();
	}
	 ...
	 */
	public List<ClanAvengePojo> fetchById(String... values) {
	 ...
	 */
	public ClanAvengePojo fetchOneById(String value) {
	 ...
	 */
	public List<ClanAvengePojo> fetchByClanId(String... values) {
	 ...
	 */
	public List<ClanAvengePojo> fetchByAttackerId(String... values) {
	 ...
	 */
	public List<ClanAvengePojo> fetchByDefenderId(String... values) {
	 ...
	 */
	public List<ClanAvengePojo> fetchByBattleEndTime(Timestamp... values) {
	 ...
	 */
	public List<ClanAvengePojo> fetchByAvengeRequestTime(Timestamp... values) {
