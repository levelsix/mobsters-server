...
public class LockBoxEventForUserPojo implements ILockBoxEventForUser {
	...
	public LockBoxEventForUserPojo() {}

	public LockBoxEventForUserPojo(LockBoxEventForUserPojo value) {
	...
	@Override
	public LockBoxEventForUserPojo setLockBoxEventId(Integer lockBoxEventId) {
		this.lockBoxEventId = lockBoxEventId;
		return this;
	}
	...
	@Override
	public LockBoxEventForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public LockBoxEventForUserPojo setNumBoxes(Integer numBoxes) {
		this.numBoxes = numBoxes;
		return this;
	}
	...
	@Override
	public LockBoxEventForUserPojo setLastOpeningTime(Timestamp lastOpeningTime) {
		this.lastOpeningTime = lastOpeningTime;
		return this;
	}
	...
	@Override
	public LockBoxEventForUserPojo setNumTimesCompleted(Integer numTimesCompleted) {
		this.numTimesCompleted = numTimesCompleted;
		return this;
	}
	...
	@Override
	public LockBoxEventForUserPojo setHasBeenRedeemed(Byte hasBeenRedeemed) {
		this.hasBeenRedeemed = hasBeenRedeemed;
		return this;
	}
