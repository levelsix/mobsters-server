...
public class MonsterSnapshotForUserPojo implements IMonsterSnapshotForUser {
	...
	public MonsterSnapshotForUserPojo() {}

	public MonsterSnapshotForUserPojo(MonsterSnapshotForUserPojo value) {
		this.id = value.id;
	...
	@Override
	public MonsterSnapshotForUserPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setTimeOfEntry(String timeOfEntry) {
		this.timeOfEntry = timeOfEntry;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setType(String type) {
		this.type = type;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setIdInTable(String idInTable) {
		this.idInTable = idInTable;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setMonsterForUserId(String monsterForUserId) {
		this.monsterForUserId = monsterForUserId;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setMonsterId(Integer monsterId) {
		this.monsterId = monsterId;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setCurrentExp(Integer currentExp) {
		this.currentExp = currentExp;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setCurrentLvl(Integer currentLvl) {
		this.currentLvl = currentLvl;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setCurrentHp(Integer currentHp) {
		this.currentHp = currentHp;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setTeamSlotNum(Integer teamSlotNum) {
		this.teamSlotNum = teamSlotNum;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setOffSkillId(Integer offSkillId) {
		this.offSkillId = offSkillId;
		return this;
	}
	...
	@Override
	public MonsterSnapshotForUserPojo setDefSkillId(Integer defSkillId) {
		this.defSkillId = defSkillId;
		return this;
	}
