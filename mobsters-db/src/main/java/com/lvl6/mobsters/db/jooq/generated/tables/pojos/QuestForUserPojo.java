...
public class QuestForUserPojo implements IQuestForUser {

	private static final long serialVersionUID = 455273417;
	...
	public QuestForUserPojo() {}

	public QuestForUserPojo(QuestForUserPojo value) {
	...
	@Override
	public QuestForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public QuestForUserPojo setQuestId(Integer questId) {
		this.questId = questId;
		return this;
	}
	...
	@Override
	public QuestForUserPojo setIsRedeemed(Byte isRedeemed) {
		this.isRedeemed = isRedeemed;
		return this;
	}
	...
	@Override
	public QuestForUserPojo setIsComplete(Byte isComplete) {
		this.isComplete = isComplete;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.QuestForUserRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.QuestForUserRecord();
		poop.from(this);
		return "QuestForUserPojo[" + poop.valuesRow() + "]";
	}
}
