...
public class StructureClanHouseConfig implements IStructureClanHouseConfig {

	private static final long serialVersionUID = -1097258177;
	...
	public StructureClanHouseConfig(StructureClanHouseConfig value) {
	...
	@Override
	public StructureClanHouseConfig setStructId(Integer structId) {
		this.structId = structId;
		return this;
	}
	...
	@Override
	public StructureClanHouseConfig setMaxHelpersPerSolicitation(Integer maxHelpersPerSolicitation) {
		this.maxHelpersPerSolicitation = maxHelpersPerSolicitation;
		return this;
	}
	...
	@Override
	public StructureClanHouseConfig setTeamDonationPowerLimit(Integer teamDonationPowerLimit) {
		this.teamDonationPowerLimit = teamDonationPowerLimit;
		return this;
	}
