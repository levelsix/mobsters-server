...
public class MiniEventTimetableConfigPojo implements IMiniEventTimetableConfig {
	...
	public MiniEventTimetableConfigPojo() {}

	public MiniEventTimetableConfigPojo(MiniEventTimetableConfigPojo value) {
		this.id = value.id;
	...
	@Override
	public MiniEventTimetableConfigPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MiniEventTimetableConfigPojo setMiniEventId(Integer miniEventId) {
		this.miniEventId = miniEventId;
		return this;
	}
	...
	@Override
	public MiniEventTimetableConfigPojo setStartTime(Timestamp startTime) {
		this.startTime = startTime;
		return this;
	}
	...
	@Override
	public MiniEventTimetableConfigPojo setEndTime(Timestamp endTime) {
		this.endTime = endTime;
		return this;
	}
