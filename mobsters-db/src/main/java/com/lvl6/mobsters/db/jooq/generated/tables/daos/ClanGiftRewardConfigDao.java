...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.ClanGiftRewardConfigPojo;
...
public class ClanGiftRewardConfigDao extends DAOImpl<ClanGiftRewardConfigRecord, ClanGiftRewardConfigPojo, Integer> {

	/**
	 * Create a new ClanGiftRewardConfigDao without any configuration
	 */
	public ClanGiftRewardConfigDao() {
		super(ClanGiftRewardConfig.CLAN_GIFT_REWARD_CONFIG, ClanGiftRewardConfigPojo.class);
	}
	...
	public ClanGiftRewardConfigDao(Configuration configuration) {
		super(ClanGiftRewardConfig.CLAN_GIFT_REWARD_CONFIG, ClanGiftRewardConfigPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Integer getId(ClanGiftRewardConfigPojo object) {
		return object.getId();
	}
	 ...
	 */
	public List<ClanGiftRewardConfigPojo> fetchById(Integer... values) {
	 ...
	 */
	public ClanGiftRewardConfigPojo fetchOneById(Integer value) {
	 ...
	 */
	public List<ClanGiftRewardConfigPojo> fetchByClanGiftId(Integer... values) {
	 ...
	 */
	public List<ClanGiftRewardConfigPojo> fetchByRewardId(Integer... values) {
	 ...
	 */
	public List<ClanGiftRewardConfigPojo> fetchByChanceOfDrop(Double... values) {
