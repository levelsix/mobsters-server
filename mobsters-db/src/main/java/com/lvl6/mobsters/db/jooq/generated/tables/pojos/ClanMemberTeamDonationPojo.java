...
public class ClanMemberTeamDonationPojo implements IClanMemberTeamDonation {
	...
	private static final long serialVersionUID = 1498773965;
	...
	public ClanMemberTeamDonationPojo() {}

	public ClanMemberTeamDonationPojo(ClanMemberTeamDonationPojo value) {
		this.id = value.id;
	...
	@Override
	public ClanMemberTeamDonationPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setClanId(String clanId) {
		this.clanId = clanId;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setPowerLimit(Integer powerLimit) {
		this.powerLimit = powerLimit;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setFulfilled(Boolean fulfilled) {
		this.fulfilled = fulfilled;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setMsg(String msg) {
		this.msg = msg;
		return this;
	}
	...
	@Override
	public ClanMemberTeamDonationPojo setTimeOfSolicitation(Timestamp timeOfSolicitation) {
		this.timeOfSolicitation = timeOfSolicitation;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.ClanMemberTeamDonationRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.ClanMemberTeamDonationRecord();
		poop.from(this);
		return "ClanMemberTeamDonationPojo[" + poop.valuesRow() + "]";
	}
}
