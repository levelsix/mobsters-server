...
public class TaskStageForUser implements ITaskStageForUser {

	private static final long serialVersionUID = -186190818;
	...
	public TaskStageForUser(TaskStageForUser value) {
		this.id = value.id;
	...
	@Override
	public TaskStageForUser setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public TaskStageForUser setTaskForUserId(String taskForUserId) {
		this.taskForUserId = taskForUserId;
		return this;
	}
	...
	@Override
	public TaskStageForUser setStageNum(Integer stageNum) {
		this.stageNum = stageNum;
		return this;
	}
	...
	@Override
	public TaskStageForUser setTaskStageMonsterId(Integer taskStageMonsterId) {
		this.taskStageMonsterId = taskStageMonsterId;
		return this;
	}
	...
	@Override
	public TaskStageForUser setMonsterType(String monsterType) {
		this.monsterType = monsterType;
		return this;
	}
	...
	@Override
	public TaskStageForUser setExpGained(Integer expGained) {
		this.expGained = expGained;
		return this;
	}
	...
	@Override
	public TaskStageForUser setCashGained(Integer cashGained) {
		this.cashGained = cashGained;
		return this;
	}
	...
	@Override
	public TaskStageForUser setOilGained(Integer oilGained) {
		this.oilGained = oilGained;
		return this;
	}
	...
	@Override
	public TaskStageForUser setMonsterPieceDropped(Boolean monsterPieceDropped) {
		this.monsterPieceDropped = monsterPieceDropped;
		return this;
	}
	...
	@Override
	public TaskStageForUser setItemIdDropped(Integer itemIdDropped) {
		this.itemIdDropped = itemIdDropped;
		return this;
	}
	...
	@Override
	public TaskStageForUser setAttackedFirst(Boolean attackedFirst) {
		this.attackedFirst = attackedFirst;
		return this;
	}
