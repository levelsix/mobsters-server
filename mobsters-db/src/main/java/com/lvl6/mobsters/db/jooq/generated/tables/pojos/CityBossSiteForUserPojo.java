...
public class CityBossSiteForUserPojo implements ICityBossSiteForUser {
	...
	public CityBossSiteForUserPojo() {}

	public CityBossSiteForUserPojo(CityBossSiteForUserPojo value) {
	...
	@Override
	public CityBossSiteForUserPojo setCityId(Integer cityId) {
		this.cityId = cityId;
		return this;
	}
	...
	@Override
	public CityBossSiteForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public CityBossSiteForUserPojo setTaskId(Integer taskId) {
		this.taskId = taskId;
		return this;
	}
	...
	@Override
	public CityBossSiteForUserPojo setBossId(Integer bossId) {
		this.bossId = bossId;
		return this;
	}
	...
	@Override
	public CityBossSiteForUserPojo setTimeOfEntry(Timestamp timeOfEntry) {
		this.timeOfEntry = timeOfEntry;
		return this;
	}
