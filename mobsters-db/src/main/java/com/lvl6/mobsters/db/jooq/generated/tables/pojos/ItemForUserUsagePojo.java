...
public class ItemForUserUsagePojo implements IItemForUserUsage {

	private static final long serialVersionUID = -1368602043;
	...
	public ItemForUserUsagePojo() {}

	public ItemForUserUsagePojo(ItemForUserUsagePojo value) {
		this.id = value.id;
	...
	@Override
	public ItemForUserUsagePojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ItemForUserUsagePojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ItemForUserUsagePojo setItemId(Integer itemId) {
		this.itemId = itemId;
		return this;
	}
	...
	@Override
	public ItemForUserUsagePojo setTimeOfEntry(Timestamp timeOfEntry) {
		this.timeOfEntry = timeOfEntry;
		return this;
	}
	...
	@Override
	public ItemForUserUsagePojo setUserDataId(String userDataId) {
		this.userDataId = userDataId;
		return this;
	}
	...
	@Override
	public ItemForUserUsagePojo setActionType(String actionType) {
		this.actionType = actionType;
		return this;
	}
	...
	public String toString() {
		com.lvl6.mobsters.db.jooq.generated.tables.records.ItemForUserUsageRecord poop = new com.lvl6.mobsters.db.jooq.generated.tables.records.ItemForUserUsageRecord();
		poop.from(this);
		return "ItemForUserUsagePojo[" + poop.valuesRow() + "]";
	}
}
