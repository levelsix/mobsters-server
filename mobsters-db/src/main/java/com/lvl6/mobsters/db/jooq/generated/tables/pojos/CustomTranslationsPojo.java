...
public class CustomTranslationsPojo implements ICustomTranslations {
	...
	public CustomTranslationsPojo() {}

	public CustomTranslationsPojo(CustomTranslationsPojo value) {
		this.id = value.id;
	...
	@Override
	public CustomTranslationsPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public CustomTranslationsPojo setPhrase(String phrase) {
		this.phrase = phrase;
		return this;
	}
	...
	@Override
	public CustomTranslationsPojo setLanguage(String language) {
		this.language = language;
		return this;
	}
