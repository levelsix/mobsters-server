...
public class MiniEventTierRewardConfigPojo implements IMiniEventTierRewardConfig {
	...
	public MiniEventTierRewardConfigPojo() {}

	public MiniEventTierRewardConfigPojo(MiniEventTierRewardConfigPojo value) {
		this.id = value.id;
	...
	@Override
	public MiniEventTierRewardConfigPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MiniEventTierRewardConfigPojo setMiniEventForPlayerLvlId(Integer miniEventForPlayerLvlId) {
		this.miniEventForPlayerLvlId = miniEventForPlayerLvlId;
		return this;
	}
	...
	@Override
	public MiniEventTierRewardConfigPojo setRewardId(Integer rewardId) {
		this.rewardId = rewardId;
		return this;
	}
	...
	@Override
	public MiniEventTierRewardConfigPojo setRewardTier(Integer rewardTier) {
		this.rewardTier = rewardTier;
		return this;
	}
