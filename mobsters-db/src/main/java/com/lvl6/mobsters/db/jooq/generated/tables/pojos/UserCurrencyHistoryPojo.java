...
public class UserCurrencyHistoryPojo implements IUserCurrencyHistory {
	...
	private static final long serialVersionUID = -1731675896;
	...
	public UserCurrencyHistoryPojo(UserCurrencyHistoryPojo value) {
		this.id = value.id;
	...
	@Override
	public UserCurrencyHistoryPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setDate(Timestamp date) {
		this.date = date;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setResourceType(String resourceType) {
		this.resourceType = resourceType;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setCurrencyChange(Integer currencyChange) {
		this.currencyChange = currencyChange;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setCurrencyBeforeChange(Integer currencyBeforeChange) {
		this.currencyBeforeChange = currencyBeforeChange;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setCurrencyAfterChange(Integer currencyAfterChange) {
		this.currencyAfterChange = currencyAfterChange;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setReasonForChange(String reasonForChange) {
		this.reasonForChange = reasonForChange;
		return this;
	}
	...
	@Override
	public UserCurrencyHistoryPojo setDetails(String details) {
		this.details = details;
		return this;
	}
