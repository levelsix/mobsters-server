...
public class EventPersistentConfigPojo implements IEventPersistentConfig {
	...
	public EventPersistentConfigPojo() {}

	public EventPersistentConfigPojo(EventPersistentConfigPojo value) {
		this.id = value.id;
	...
	@Override
	public EventPersistentConfigPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setDayOfWeek(String dayOfWeek) {
		this.dayOfWeek = dayOfWeek;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setStartHour(Byte startHour) {
		this.startHour = startHour;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setEventDurationMinutes(Integer eventDurationMinutes) {
		this.eventDurationMinutes = eventDurationMinutes;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setTaskId(Integer taskId) {
		this.taskId = taskId;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setCooldownMinutes(Integer cooldownMinutes) {
		this.cooldownMinutes = cooldownMinutes;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setEventType(String eventType) {
		this.eventType = eventType;
		return this;
	}
	...
	@Override
	public EventPersistentConfigPojo setMonsterElement(String monsterElement) {
		this.monsterElement = monsterElement;
		return this;
	}
