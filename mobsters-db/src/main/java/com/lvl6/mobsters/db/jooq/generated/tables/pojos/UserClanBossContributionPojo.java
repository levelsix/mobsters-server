...
public class UserClanBossContributionPojo implements IUserClanBossContribution {
	...
	public UserClanBossContributionPojo() {}

	public UserClanBossContributionPojo(UserClanBossContributionPojo value) {
	...
	@Override
	public UserClanBossContributionPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setClanId(String clanId) {
		this.clanId = clanId;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setBossId(Integer bossId) {
		this.bossId = bossId;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setTotalDamageDone(Integer totalDamageDone) {
		this.totalDamageDone = totalDamageDone;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setTotalEnergyUsed(Integer totalEnergyUsed) {
		this.totalEnergyUsed = totalEnergyUsed;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setNumRunesOne(Integer numRunesOne) {
		this.numRunesOne = numRunesOne;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setNumRunesTwo(Integer numRunesTwo) {
		this.numRunesTwo = numRunesTwo;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setNumRunesThree(Integer numRunesThree) {
		this.numRunesThree = numRunesThree;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setNumRunesFour(Integer numRunesFour) {
		this.numRunesFour = numRunesFour;
		return this;
	}
	...
	@Override
	public UserClanBossContributionPojo setNumRunesFive(Integer numRunesFive) {
		this.numRunesFive = numRunesFive;
		return this;
	}
