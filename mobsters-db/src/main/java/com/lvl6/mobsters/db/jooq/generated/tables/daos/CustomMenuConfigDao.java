...
public class CustomMenuConfigDao extends DAOImpl<CustomMenuConfigRecord, CustomMenuConfigPojo, Record2<Integer, Integer>> {

	/**
	 * Create a new CustomMenuConfigDao without any configuration
	 */
	public CustomMenuConfigDao() {
		super(CustomMenuConfig.CUSTOM_MENU_CONFIG, CustomMenuConfigPojo.class);
	}
	...
	public CustomMenuConfigDao(Configuration configuration) {
		super(CustomMenuConfig.CUSTOM_MENU_CONFIG, CustomMenuConfigPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Record2<Integer, Integer> getId(CustomMenuConfigPojo object) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByCustomMenuId(Integer... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByPositionX(Integer... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByPositionY(Integer... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByPositionZ(Integer... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByIsJiggle(Boolean... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByImageName(String... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByIpadPositionX(Integer... values) {
	 ...
	 */
	public List<CustomMenuConfigPojo> fetchByIpadPositionY(Integer... values) {
