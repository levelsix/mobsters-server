...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.CepfuRaidStageHistoryPojo;
...
public class CepfuRaidStageHistoryDao extends DAOImpl<CepfuRaidStageHistoryRecord, CepfuRaidStageHistoryPojo, Record3<String, Timestamp, String>> {

	/**
	 * Create a new CepfuRaidStageHistoryDao without any configuration
	 */
	public CepfuRaidStageHistoryDao() {
		super(CepfuRaidStageHistory.CEPFU_RAID_STAGE_HISTORY, CepfuRaidStageHistoryPojo.class);
	}
	...
	public CepfuRaidStageHistoryDao(Configuration configuration) {
		super(CepfuRaidStageHistory.CEPFU_RAID_STAGE_HISTORY, CepfuRaidStageHistoryPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Record3<String, Timestamp, String> getId(CepfuRaidStageHistoryPojo object) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByUserId(String... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByCrsStartTime(Timestamp... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByClanId(String... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByClanEventPersistentId(Integer... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByCrId(Integer... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByCrsId(Integer... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByCrsDmgDone(Integer... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByStageHealth(Integer... values) {
	 ...
	 */
	public List<CepfuRaidStageHistoryPojo> fetchByCrsEndTime(Timestamp... values) {
