...
public class MiniEventGoalForUserDao extends DAOImpl<MiniEventGoalForUserRecord, MiniEventGoalForUserPojo, Record2<String, Integer>> {
	 ...
	 */
	@Override
	protected Record2<String, Integer> getId(MiniEventGoalForUserPojo object) {
