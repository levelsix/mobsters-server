...
public class MiniJobForUserPojo implements IMiniJobForUser {
	...
	public MiniJobForUserPojo() {}

	public MiniJobForUserPojo(MiniJobForUserPojo value) {
		this.id = value.id;
	...
	@Override
	public MiniJobForUserPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setMiniJobId(Integer miniJobId) {
		this.miniJobId = miniJobId;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setBaseDmgReceived(Integer baseDmgReceived) {
		this.baseDmgReceived = baseDmgReceived;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setDurationMinutes(Integer durationMinutes) {
		this.durationMinutes = durationMinutes;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setTimeStarted(Timestamp timeStarted) {
		this.timeStarted = timeStarted;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setUserMonsterIds(String userMonsterIds) {
		this.userMonsterIds = userMonsterIds;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setTimeCompleted(Timestamp timeCompleted) {
		this.timeCompleted = timeCompleted;
		return this;
	}
	...
	@Override
	public MiniJobForUserPojo setDurationSeconds(Integer durationSeconds) {
		this.durationSeconds = durationSeconds;
		return this;
	}
