...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.LockBoxEventConfigPojo;
...
public class LockBoxEventConfigDao extends DAOImpl<LockBoxEventConfigRecord, LockBoxEventConfigPojo, Integer> {

	/**
	 * Create a new LockBoxEventConfigDao without any configuration
	 */
	public LockBoxEventConfigDao() {
		super(LockBoxEventConfig.LOCK_BOX_EVENT_CONFIG, LockBoxEventConfigPojo.class);
	}
	...
	public LockBoxEventConfigDao(Configuration configuration) {
		super(LockBoxEventConfig.LOCK_BOX_EVENT_CONFIG, LockBoxEventConfigPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Integer getId(LockBoxEventConfigPojo object) {
		return object.getId();
	}
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchById(Integer... values) {
	 ...
	 */
	public LockBoxEventConfigPojo fetchOneById(Integer value) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByStartTime(Timestamp... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByEndTime(Timestamp... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByLockBoxImageName(String... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByEventName(String... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByPrizeEquipId(Integer... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByDescriptionString(String... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByDescriptionImageName(String... values) {
	 ...
	 */
	public List<LockBoxEventConfigPojo> fetchByTagImageName(String... values) {
