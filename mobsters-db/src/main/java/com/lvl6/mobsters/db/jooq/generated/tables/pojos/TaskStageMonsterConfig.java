...
public class TaskStageMonsterConfig implements ITaskStageMonsterConfig {

	private static final long serialVersionUID = 1338699870;
	...
	public TaskStageMonsterConfig(TaskStageMonsterConfig value) {
		this.id = value.id;
	...
	@Override
	public TaskStageMonsterConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setTaskStageId(Integer taskStageId) {
		this.taskStageId = taskStageId;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMonsterId(Integer monsterId) {
		this.monsterId = monsterId;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMonsterType(String monsterType) {
		this.monsterType = monsterType;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setExpReward(Integer expReward) {
		this.expReward = expReward;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMinCashDrop(Integer minCashDrop) {
		this.minCashDrop = minCashDrop;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMaxCashDrop(Integer maxCashDrop) {
		this.maxCashDrop = maxCashDrop;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMinOilDrop(Integer minOilDrop) {
		this.minOilDrop = minOilDrop;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMaxOilDrop(Integer maxOilDrop) {
		this.maxOilDrop = maxOilDrop;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setPuzzlePieceDropRate(Double puzzlePieceDropRate) {
		this.puzzlePieceDropRate = puzzlePieceDropRate;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setLevel(Integer level) {
		this.level = level;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setChanceToAppear(Double chanceToAppear) {
		this.chanceToAppear = chanceToAppear;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setDmgMultiplier(Double dmgMultiplier) {
		this.dmgMultiplier = dmgMultiplier;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMonsterIdDrop(Integer monsterIdDrop) {
		this.monsterIdDrop = monsterIdDrop;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setMonsterDropLvl(Integer monsterDropLvl) {
		this.monsterDropLvl = monsterDropLvl;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setDefensiveSkillId(Integer defensiveSkillId) {
		this.defensiveSkillId = defensiveSkillId;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setInitDialogue(String initDialogue) {
		this.initDialogue = initDialogue;
		return this;
	}
	...
	@Override
	public TaskStageMonsterConfig setDefaultDialogue(String defaultDialogue) {
		this.defaultDialogue = defaultDialogue;
		return this;
	}
