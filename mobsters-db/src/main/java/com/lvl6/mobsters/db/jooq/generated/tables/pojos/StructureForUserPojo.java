...
public class StructureForUserPojo implements IStructureForUser {
	...
	public StructureForUserPojo() {}

	public StructureForUserPojo(StructureForUserPojo value) {
		this.id = value.id;
	...
	@Override
	public StructureForUserPojo setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setStructId(Integer structId) {
		this.structId = structId;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setLastRetrieved(Timestamp lastRetrieved) {
		this.lastRetrieved = lastRetrieved;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setXcoord(Integer xcoord) {
		this.xcoord = xcoord;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setYcoord(Integer ycoord) {
		this.ycoord = ycoord;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setPurchaseTime(Timestamp purchaseTime) {
		this.purchaseTime = purchaseTime;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setIsComplete(Byte isComplete) {
		this.isComplete = isComplete;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setOrientation(String orientation) {
		this.orientation = orientation;
		return this;
	}
	...
	@Override
	public StructureForUserPojo setFbInviteStructLvl(Byte fbInviteStructLvl) {
		this.fbInviteStructLvl = fbInviteStructLvl;
		return this;
	}
