...
public class LockBoxItemConfig implements ILockBoxItemConfig {

	private static final long serialVersionUID = 951213153;
	...
	public LockBoxItemConfig(LockBoxItemConfig value) {
		this.id = value.id;
	...
	@Override
	public LockBoxItemConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setLockBoxEventId(Integer lockBoxEventId) {
		this.lockBoxEventId = lockBoxEventId;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setChanceToUnlock(Double chanceToUnlock) {
		this.chanceToUnlock = chanceToUnlock;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setClassType(Byte classType) {
		this.classType = classType;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setImageName(String imageName) {
		this.imageName = imageName;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setRedeemForNumBoosterItems(Integer redeemForNumBoosterItems) {
		this.redeemForNumBoosterItems = redeemForNumBoosterItems;
		return this;
	}
	...
	@Override
	public LockBoxItemConfig setIsGoldBoosterPack(Byte isGoldBoosterPack) {
		this.isGoldBoosterPack = isGoldBoosterPack;
		return this;
	}
