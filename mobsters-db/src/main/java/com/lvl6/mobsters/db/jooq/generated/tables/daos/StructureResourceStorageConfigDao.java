...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.StructureResourceStorageConfigPojo;
...
public class StructureResourceStorageConfigDao extends DAOImpl<StructureResourceStorageConfigRecord, StructureResourceStorageConfigPojo, Integer> {

	/**
	 * Create a new StructureResourceStorageConfigDao without any configuration
	 */
	public StructureResourceStorageConfigDao() {
		super(StructureResourceStorageConfig.STRUCTURE_RESOURCE_STORAGE_CONFIG, StructureResourceStorageConfigPojo.class);
	}
	...
	public StructureResourceStorageConfigDao(Configuration configuration) {
		super(StructureResourceStorageConfig.STRUCTURE_RESOURCE_STORAGE_CONFIG, StructureResourceStorageConfigPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Integer getId(StructureResourceStorageConfigPojo object) {
	 ...
	 */
	public List<StructureResourceStorageConfigPojo> fetchByStructId(Integer... values) {
	 ...
	 */
	public StructureResourceStorageConfigPojo fetchOneByStructId(Integer value) {
	 ...
	 */
	public List<StructureResourceStorageConfigPojo> fetchByResourceTypeStored(String... values) {
	 ...
	 */
	public List<StructureResourceStorageConfigPojo> fetchByCapacity(Integer... values) {
