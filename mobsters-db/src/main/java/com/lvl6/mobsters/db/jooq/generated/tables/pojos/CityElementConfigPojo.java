...
public class CityElementConfigPojo implements ICityElementConfig {
	...
	public CityElementConfigPojo() {}

	public CityElementConfigPojo(CityElementConfigPojo value) {
	...
	@Override
	public CityElementConfigPojo setCityId(Integer cityId) {
		this.cityId = cityId;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setAssetId(Integer assetId) {
		this.assetId = assetId;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setElemType(String elemType) {
		this.elemType = elemType;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setXCoordinate(Double xCoordinate) {
		this.xCoordinate = xCoordinate;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setYCoordinate(Double yCoordinate) {
		this.yCoordinate = yCoordinate;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setXLength(Double xLength) {
		this.xLength = xLength;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setYLength(Double yLength) {
		this.yLength = yLength;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setImgIdGood(String imgIdGood) {
		this.imgIdGood = imgIdGood;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setOrientation(String orientation) {
		this.orientation = orientation;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setSpriteLandingCoordinateX(Double spriteLandingCoordinateX) {
		this.spriteLandingCoordinateX = spriteLandingCoordinateX;
		return this;
	}
	...
	@Override
	public CityElementConfigPojo setSpriteLandingCoordinateY(Double spriteLandingCoordinateY) {
		this.spriteLandingCoordinateY = spriteLandingCoordinateY;
		return this;
	}
