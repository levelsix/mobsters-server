...
public class AlertOnStartupPojo implements IAlertOnStartup {
	...
	public AlertOnStartupPojo() {}

	public AlertOnStartupPojo(AlertOnStartupPojo value) {
		this.id = value.id;
	...
	@Override
	public AlertOnStartupPojo setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public AlertOnStartupPojo setMessage(String message) {
		this.message = message;
		return this;
	}
	...
	@Override
	public AlertOnStartupPojo setIsActive(Boolean isActive) {
		this.isActive = isActive;
		return this;
	}
