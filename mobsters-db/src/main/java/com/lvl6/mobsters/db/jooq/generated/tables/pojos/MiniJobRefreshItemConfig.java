...
public class MiniJobRefreshItemConfig implements IMiniJobRefreshItemConfig {

	private static final long serialVersionUID = 1057086352;
	...
	public MiniJobRefreshItemConfig(MiniJobRefreshItemConfig value) {
	...
	@Override
	public MiniJobRefreshItemConfig setStructId(Integer structId) {
		this.structId = structId;
		return this;
	}
	...
	@Override
	public MiniJobRefreshItemConfig setItemId(Integer itemId) {
		this.itemId = itemId;
		return this;
	}
	...
	@Override
	public MiniJobRefreshItemConfig setGemPrice(Integer gemPrice) {
		this.gemPrice = gemPrice;
		return this;
	}
