...
import com.lvl6.mobsters.db.jooq.generated.tables.pojos.ClanIconConfigPojo;
...
public class ClanIconConfigDao extends DAOImpl<ClanIconConfigRecord, ClanIconConfigPojo, Integer> {

	/**
	 * Create a new ClanIconConfigDao without any configuration
	 */
	public ClanIconConfigDao() {
		super(ClanIconConfig.CLAN_ICON_CONFIG, ClanIconConfigPojo.class);
	}
	...
	public ClanIconConfigDao(Configuration configuration) {
		super(ClanIconConfig.CLAN_ICON_CONFIG, ClanIconConfigPojo.class, configuration);
	}
	 ...
	 */
	@Override
	protected Integer getId(ClanIconConfigPojo object) {
		return object.getId();
	}
	 ...
	 */
	public List<ClanIconConfigPojo> fetchById(Integer... values) {
	 ...
	 */
	public ClanIconConfigPojo fetchOneById(Integer value) {
	 ...
	 */
	public List<ClanIconConfigPojo> fetchByImgName(String... values) {
	 ...
	 */
	public List<ClanIconConfigPojo> fetchByIsAvailable(Boolean... values) {
