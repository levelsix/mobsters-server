...
public class UpdateUtils implements UpdateUtil {
	...
	@Override
	public boolean updateUserCityExpansionData(String userId, int xPosition,
			int yPosition, boolean isExpanding, Timestamp expandStartTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.EXPANSION_PURCHASE_FOR_USER__USER_ID,
				userId);
		conditionParams.put(
				DBConstants.EXPANSION_PURCHASE_FOR_USER__X_POSITION, xPosition);
		conditionParams.put(
				DBConstants.EXPANSION_PURCHASE_FOR_USER__Y_POSITION, yPosition);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(
				DBConstants.EXPANSION_PURCHASE_FOR_USER__IS_EXPANDING,
				isExpanding);
		absoluteParams.put(
		...
		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_EXPANSION_PURCHASE_FOR_USER, null,
	...
	public boolean updateUserQuestIscomplete(String userId, int questId) {
		...
		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_QUEST_FOR_USER, null, absoluteParams,
				conditionParams, "and");
		if (numUpdated == 1) {
			return true;
		}
	...
	public int updateUserQuestJobs(String userId,
		...
		for (Integer questJobId : questJobIdToQuestJob.keySet()) {
			...
			newRow.put(DBConstants.QUEST_JOB_FOR_USER__QUEST_ID,
					qjfu.getQuestId());
			newRow.put(DBConstants.QUEST_JOB_FOR_USER__QUEST_JOB_ID, questJobId);
	...
	public int updateUserAchievement(String userId, Timestamp completeTime,
		...
		replaceTheseColumns
				.add(DBConstants.ACHIEVEMENT_FOR_USER__TIME_COMPLETED);
	...
	public int updateRedeemAchievementForUser(String userId,
		...
		replaceTheseColumns
				.add(DBConstants.ACHIEVEMENT_FOR_USER__TIME_REDEEMED);
	...
	public boolean updateUserStructOrientation(String userStructId,
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__ORIENTATION,
				orientation.getNumber());

		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_STRUCTURE_FOR_USER, null, absoluteParams,
				conditionParams, "or");
		if (numUpdated == 1) {
			return true;
		}
	...
	public boolean updateBeginUpgradingUserStruct(String userStructId,
		...
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__STRUCT_ID,
				newStructId);
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__PURCHASE_TIME,
				upgradeTime);
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__IS_COMPLETE, false);

		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_STRUCTURE_FOR_USER, relativeParams,
				absoluteParams, conditionParams, "or");
		if (numUpdated == 1) {
			return true;
		}
		return false;
	...
	@Override
	public boolean updateSpeedupUpgradingUserStruct(String userStructId,
		...
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__LAST_RETRIEVED,
				lastRetrievedTime);
	...
	@Override
	public boolean updatePurchaseTimeRetrieveTimeForMoneyTree(
	...
	public boolean updateUserStructsBuildingIsComplete(String userId,
		...
		for (int index = 0; index < newRetrievedTimes.size(); index++) {
			...
			newRow.put(DBConstants.STRUCTURE_FOR_USER__LAST_RETRIEVED,
					lastRetrievedTime);
			...
			newRow.put(DBConstants.STRUCTURE_FOR_USER__ORIENTATION,
					userStruct.getOrientation());
		...
		log.info("num userStructs updated: " + numUpdated
				+ ". Number of userStructs: " + userStructs.size()
	...
	*/
	@Override
	public boolean updateUserStructFbLevel(String userStructId,
			int nuFbInviteLevel) {
		String tableName = DBConstants.TABLE_STRUCTURE_FOR_USER;
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(
				DBConstants.STRUCTURE_FOR_USER__FB_INVITE_STRUCT_LVL,
				nuFbInviteLevel);
	 ...
	 */
	@Override
	public boolean updateUserStructCoord(String userStructId,
			CoordinatePair coordinates) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.STRUCTURE_FOR_USER__ID, userStructId);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__X_COORD,
				coordinates.getX());
		absoluteParams.put(DBConstants.STRUCTURE_FOR_USER__Y_COORD,
				coordinates.getY());
	...
	@Override
	public boolean incrementNumberOfLockBoxesForLockBoxEvent(String userId,
			int eventId, int increment) {
		Map<String, Object> insertParams = new HashMap<String, Object>();

		insertParams.put(DBConstants.LOCK_BOX_EVENT_FOR_USER__USER_ID, userId);
		insertParams
				.put(DBConstants.LOCK_BOX_EVENT_FOR_USER__EVENT_ID, eventId);
		insertParams.put(DBConstants.LOCK_BOX_EVENT_FOR_USER__NUM_BOXES,
				increment);
		insertParams.put(
				DBConstants.LOCK_BOX_EVENT_FOR_USER__NUM_TIMES_COMPLETED, 0);

		Map<String, Object> columnsToUpdate = new HashMap<String, Object>();
		columnsToUpdate.put(DBConstants.LOCK_BOX_EVENT_FOR_USER__NUM_BOXES,
				increment);

		int numUpdated = DBConnection.get().insertOnDuplicateKeyUpdate(
				DBConstants.TABLE_LOCK_BOX_EVENT_FOR_USER, insertParams,
	...
	@Override
	public boolean updateUserClanStatus(String userId, String clanId,
		...
		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_CLAN_FOR_USER, null, absoluteParams,
				conditionParams, "and");
		if (numUpdated == 1) {
			return true;
		}
	...
	public boolean updateUsersAddDiamonds(List<String> userIds, int diamonds) {
		...
		int numUpdated = DBConnection.get().updateDirectQueryNaive(query,
				values);
	...
	public boolean updateLeaderboardEventSetRewardGivenOut(int eventId) {
		...
		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_TOURNAMENT_EVENT_CONFIG, null,
				absoluteParams, conditionParams, "or");
		if (numUpdated == 1) {
			return true;
		}
	...
	public boolean updateClanJoinTypeForClan(String clanId,
			boolean requestToJoinRequired) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.CLANS__ID, clanId);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.CLANS__REQUEST_TO_JOIN_REQUIRED,
				requestToJoinRequired);

		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_CLANS, null, absoluteParams, conditionParams,
				"or");
		if (numUpdated == 1) {
			return true;
		}
	...
	@Override
	public int incrementUserTaskNumRevives(String userTaskId,
			int numRevivesDelta) {
		...
		relativeParams.put(DBConstants.TASK_FOR_USER_ONGOING__NUM_REVIVES,
				numRevivesDelta);
	...
	@Override
	public int updateUserMonstersHealth(
		...
		//QUERY GENERATION
		String query = "INSERT INTO " + DBConstants.TABLE_MONSTER_FOR_USER
				+ " (" + columns + ") VALUES ";
		String valuesList = StringUtils.getListInString(clauses, ",");
		query += valuesList + " ON DUPLICATE KEY UPDATE " + currentHealth
	...
	@Override
	public int updateUserMonsterHealing(String userId,
		...
		for (MonsterHealingForUser mhfu : monsters) {
			...
			aRow.put(DBConstants.MONSTER_HEALING_FOR_USER__MONSTER_FOR_USER_ID,
					mhfu.getMonsterForUserId());
			...
			aRow.put(DBConstants.MONSTER_HEALING_FOR_USER__QUEUED_TIME,
					queuedTime);
			aRow.put(
					DBConstants.MONSTER_HEALING_FOR_USER__USER_STRUCT_HOSPITAL_ID,
	...
	@Override
	public int updateNullifyUserMonstersTeamSlotNum(
		...
		for (int i = 0; i < size; i++) {
			...
			conditionParams
					.put(DBConstants.MONSTER_FOR_USER__ID, userMonsterId);
			absoluteParams.put(DBConstants.MONSTER_FOR_USER__TEAM_SLOT_NUM,
					teamSlotNum);
		}
	...
	@Override
	public int updateUserMonsterTeamSlotNum(String userMonsterId,
			int teamSlotNum) {
		String tableName = DBConstants.TABLE_MONSTER_FOR_USER;
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
	...
	public int nullifyMonstersTeamSlotNum(List<String> userMonsterIds,
		...
		String query = "UPDATE " + DBConstants.TABLE_MONSTER_FOR_USER + " SET "
				+ DBConstants.MONSTER_FOR_USER__TEAM_SLOT_NUM + "=? "
				+ "where " + DBConstants.MONSTER_FOR_USER__ID + " in (";

		List<String> questions = Collections
				.nCopies(userMonsterIds.size(), "?");
	...
	@Override
	public int updateUserMonsterEnhancing(String userId,
		...
		for (MonsterEnhancingForUser mhfu : monsters) {
			...
			if (null != d) {
				...
				aRow.put(
						DBConstants.MONSTER_ENHANCING_FOR_USER__EXPECTED_START_TIME,
						startTime);
			} else {
				aRow.put(
						DBConstants.MONSTER_ENHANCING_FOR_USER__EXPECTED_START_TIME,
			...
			aRow.put(DBConstants.MONSTER_ENHANCING_FOR_USER__ENHANCING_COST,
					enhancingCost);
		...
		log.info(String
				.format("num monster_enhancing updated: %s. Number of monster_enhancing: %s",
						numUpdated, monsters.size()));
		return numUpdated;
	}
	...
	public int updateCompleteEnhancing(String userId, String curEnhancingMfuId) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.MONSTER_ENHANCING_FOR_USER__USER_ID,
				userId);
		conditionParams.put(
				DBConstants.MONSTER_ENHANCING_FOR_USER__MONSTER_FOR_USER_ID,
				curEnhancingMfuId);
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(
				DBConstants.MONSTER_ENHANCING_FOR_USER__ENHANCING_COMPLETE,
				true);

		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_MONSTER_ENHANCING_FOR_USER, null,
				absoluteParams, conditionParams, "and");
		return numUpdated;
	}
	...
	@Override
	public int updateUserMonsterExpAndLvl(String userEquipId, int newExp,
			int newLvl, int newHp) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.MONSTER_FOR_USER__ID, userEquipId);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.MONSTER_FOR_USER__CURRENT_EXPERIENCE,
				newExp);
		...
		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_MONSTER_FOR_USER, null, absoluteParams,
				conditionParams, "and");
		return numUpdated;
	}
...
//					mfu.getCurrentHealth());
			...
			aRow.put(DBConstants.MONSTER_FOR_USER__HAS_ALL_PIECES,
					mfu.isHasAllPieces());
			aRow.put(DBConstants.MONSTER_FOR_USER__IS_COMPLETE,
					mfu.isComplete());
...
//				newRows);
	...
	public int updateCompleteUserMonster(List<String> userMonsterIds) {
		...
		String query = "UPDATE " + tableName + " SET "
				+ DBConstants.MONSTER_FOR_USER__IS_COMPLETE + "=? WHERE "
	...
	@Override
	public int updateUserFacebookInviteForSlotAcceptTime(
		...
		log.info("\t\t\t\t updateUserFacebookInviteForSlotAcceptTime query="
				+ query + "\t values=" + values);
		int numUpdated = DBConnection.get().updateDirectQueryNaive(query,
				values);
	...
	@Override
	public int updateClanEventPersistentForClanGoToNextStage(String clanId,
		...
		Map<String, Object> relativeParams = null;
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_CLAN__CRS_ID,
				crsId);
		absoluteParams.put(
				DBConstants.CLAN_EVENT_PERSISTENT_FOR_CLAN__STAGE_START_TIME,
				null);
		absoluteParams.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_CLAN__CRSM_ID,
				crsmId);
		absoluteParams
				.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_CLAN__STAGE_MONSTER_START_TIME,
						null);
	...
	@Override
	public int updateClanEventPersistentForUserGoToNextStage(int crsId,
		...
		for (String userId : userIdToCepfu.keySet()) {
			...
			Map<String, Object> aRow = new HashMap<String, Object>();
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__USER_ID,
					cepfu.getUserId());
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CLAN_ID,
					cepfu.getClanId());
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CR_ID,
					cepfu.getCrId());

			int newCrDmgDone = cepfu.getCrDmgDone() + cepfu.getCrsDmgDone()
					+ cepfu.getCrsmDmgDone();
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CR_DMG_DONE,
					newCrDmgDone);
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRS_ID, crsId);

			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRS_DMG_DONE,
					0);
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRSM_ID,
					crsmId);
			aRow.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRSM_DMG_DONE,
					0);
		...
		Set<String> replaceTheseColumns = new HashSet<String>();
		replaceTheseColumns
				.add(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CR_DMG_DONE);
		replaceTheseColumns
				.add(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRS_ID);
		replaceTheseColumns
				.add(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRS_DMG_DONE);
		replaceTheseColumns
				.add(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRSM_ID);
		replaceTheseColumns
				.add(DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRSM_DMG_DONE);
	...
	@Override
	public int updateClanEventPersistentForUserCrsmDmgDone(String userId,
			int dmgDealt, int crsId, int crsmId) {
		String tableName = DBConstants.TABLE_CLAN_EVENT_PERSISTENT_FOR_USER;
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(
				DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__USER_ID, userId);

		Map<String, Object> relativeParams = new HashMap<String, Object>();
		relativeParams.put(
				DBConstants.CLAN_EVENT_PERSISTENT_FOR_USER__CRSM_DMG_DONE,
				dmgDealt);
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.CLAN_EVENT_PERSISTENT_FOR_CLAN__CRS_ID,
				crsId);
	...
	public int updatePvpBattleHistoryExactRevenge(String historyAttackerId,
		...
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.PVP_BATTLE_HISTORY__ATTACKER_ID,
				historyAttackerId);
		conditionParams.put(DBConstants.PVP_BATTLE_HISTORY__DEFENDER_ID,
				historyDefenderId);
		conditionParams.put(DBConstants.PVP_BATTLE_HISTORY__BATTLE_END_TIME,
				battleEndTime);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.PVP_BATTLE_HISTORY__EXACTED_REVENGE,
				true);
	...
	@Override
	public int updateObstacleForUserRemovalTime(String ofuId,
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.OBSTACLE_FOR_USER__REMOVAL_TIME,
				clientTime);
	...
	@Override
	@CacheEvict(value = "clanWithId", key = "#clanId")
	public int updateClan(String clanId, boolean isChangeDescription,
	...
	@Override
	public int updatePvpLeagueForUserShields(String userId,
		...
		if (null != shieldEndTime) {
			absoluteParams.put(
					DBConstants.PVP_LEAGUE_FOR_USER__SHIELD_END_TIME,
					shieldEndTime);
		}
		if (null != inBattleEndTime) {
			absoluteParams.put(
					DBConstants.PVP_LEAGUE_FOR_USER__BATTLE_END_TIME,
					inBattleEndTime);
		}
	...
	public int updatePvpLeagueForUser(String userId, int newPvpLeagueId,
		...
		if (nuPvpDmgMultiplier > 0) {
			absoluteParams.put(
					DBConstants.PVP_LEAGUE_FOR_USER__MONSTER_DMG_MULTIPLIER,
					nuPvpDmgMultiplier);
		}
	...
	public int updateMiniJobForUser(String userId, String userMiniJobId,
		...
		absoluteParams.put(DBConstants.MINI_JOB_FOR_USER__USER_MONSTER_IDS,
				userMonsterIdStr);
		absoluteParams.put(DBConstants.MINI_JOB_FOR_USER__TIME_STARTED, now);
	...
	public int updateMiniJobForUserCompleteTime(String userId,
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.MINI_JOB_FOR_USER__TIME_COMPLETED, now);
	...
	@Override
	public int updateRestrictUserMonsters(String userId,
		...
		String query = querySb.toString();
		log.info(String
				.format("updateRestrictUserMonsters query=%s, values=%s",
						query, values));
		int numUpdated = DBConnection.get().updateDirectQueryNaive(query,
				values);
	...
	@Override
	public int updateUnrestrictUserMonsters(String userId,
			List<String> userMonsterIdList) {
		String tableName = DBConstants.TABLE_MONSTER_FOR_USER;
		int size = userMonsterIdList.size();
		List<String> questions = Collections.nCopies(size, "?");
	...
	public int updateTaskStageForUserNoMonsterDrop(String droplessTsfuId) {
		...
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams
				.put(DBConstants.TASK_STAGE_FOR_USER__ID, droplessTsfuId);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(
				DBConstants.TASK_STAGE_FOR_USER__MONSTER_PIECE_DROPPED, false);
	...
	public int updateClanHelp(String userId, String clanId,
		...
		String query = String.format(
				...
				tableName, helpers, helpers, DBConstants.CLAN_HELP__CLAN_ID,
	...
	public int updatePvpBattleHistoryClanRetaliated(
		...
		List<String> questions = Collections.nCopies(historyAttackerId.size(),
				"?");
		String questionMarks = StringUtils.implode(questions, ",");

		String query = String
				.format("UPDATE %s SET %s=? WHERE %s in (%s) and %s in (%s) and %s in (%s)",
						tableName, clanAvenge, attackerId, questionMarks,
						defenderId, questionMarks, battleEndTimeStr,
						questionMarks);
	...
	public int updateRecentPvpBattleHistoryClanRetaliated(
		...
		String query = String.format(
				"UPDATE %s SET %s=? WHERE %s in (%s) and %s > ?", tableName,
				clanAvenge, defenderId, questionMarks, battleEndTimeStr);
	...
	public int updateClanMemberTeamDonation(ClanMemberTeamDonation cmtd) {
		...
		absoluteParams.put(DBConstants.CLAN_MEMBER_TEAM_DONATION__MSG,
				cmtd.getMsg());
		absoluteParams.put(
				DBConstants.CLAN_MEMBER_TEAM_DONATION__TIME_OF_SOLICITATION,
	...
	public boolean updateUserResearch(String userResearchUuid, int researchId,
		...
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams
				.put(DBConstants.RESEARCH_FOR_USER__ID, userResearchUuid);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.RESEARCH_FOR_USER__RESEARCH_ID,
				researchId);
		absoluteParams.put(DBConstants.RESEARCH_FOR_USER__IS_COMPLETE, false);
		absoluteParams.put(DBConstants.RESEARCH_FOR_USER__TIME_PURCHASED,
				timeOfPurchase);

		int numUpdated = DBConnection.get().updateTableRows(
				DBConstants.TABLE_RESEARCH_FOR_USER, null, absoluteParams,
				conditionParams, "and");
		if (numUpdated == 1) {
			return true;
		}
