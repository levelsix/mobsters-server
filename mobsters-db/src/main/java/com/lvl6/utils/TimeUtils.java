...
public class TimeUtils {
	...
	public static DateTimeZone PST = DateTimeZone.forTimeZone(TimeZone
	...
	public Date createPstDate(Date curDate, int dayOffset, int hour,
			int minutesAddend) {
	 ...
	 * @return
	 */
	public Date createDateAddMinutes(Date curDate, int minutesAddend) {
		DateTime dt = new DateTime(curDate);
