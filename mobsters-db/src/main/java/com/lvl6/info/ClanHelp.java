...
public class ClanHelp implements Serializable {
	...
	public ClanHelp(String id, String userId, String userDataId,
			String helpType, String clanId, Date timeOfEntry, int maxHelpers,
			List<String> helpers, boolean open, int staticDataId) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public String toString() {
		return "ClanHelp [id=" + id + ", userId=" + userId + ", userDataId="
				+ userDataId + ", helpType=" + helpType + ", clanId=" + clanId
				+ ", timeOfEntry=" + timeOfEntry + ", maxHelpers=" + maxHelpers
				+ ", helpers=" + helpers + ", open=" + open + ", staticDataId="
				+ staticDataId + "]";
	}
