...
public class User implements Serializable {
	...
	public boolean updateSetFacebookId(String facebookId,
			boolean fbIdSetOnUserCreate, String email, String fbData) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);

		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__FACEBOOK_ID, facebookId);
		absoluteParams.put(DBConstants.USER__FB_ID_SET_ON_USER_CREATE,
				fbIdSetOnUserCreate);
	 ...
	 */
	public boolean updateRelativeCashOilExpTasksCompleted(int expChange,
			int cashChange, int oilChange, int tasksCompletedChange,
	...
	public boolean updateRelativeDiamondsBeginnerSale(int diamondChange,
		...
		if (isBeginnerSale) {
			relativeParams.put(DBConstants.USER__NUM_BEGINNER_SALES_PURCHASED,
					1);
		}
	...
	public boolean updateGemsCashClan(int gemChange, int cashChange,
			String clanId) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	...
	public boolean updateRelativeCoinsOilRetrievedFromStructs(int coinChange,
		...
		if (oilChange != 0) {
			relativeParams.put(DBConstants.USER__OIL, oilChange);
			relativeParams
					.put(DBConstants.USER__NUM_OIL_RETRIEVED_FROM_STRUCTS,
							oilChange);
		}
		if (gemsChange != 0) {
	...
	public boolean updateRelativeGemsObstacleTimeNumRemoved(int gemChange,
		...
		if (null != lastObstacleSpawnedTime) {
			absoluteParams.put(DBConstants.USER__LAST_OBSTACLE_SPAWNED_TIME,
	...
	public boolean updateLastMiniJobGeneratedTime(Date now, Timestamp nowTime) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		if (null != nowTime) {
			absoluteParams.put(DBConstants.USER__LAST_MINI_JOB_GENERATED_TIME,
					nowTime);
		}
	...
	public boolean updateResetAccount() {
		...
		if (null != udid && !udid.isEmpty()) {
			absoluteParams.put(DBConstants.USER__UDID,
					String.format("%s_reset", udid));
		}
		if (null != facebookId && facebookId != null) {
			absoluteParams.put(DBConstants.USER__FACEBOOK_ID,
					String.format("%s_reset", facebookId));
		}
	...
	public boolean updateAvatarMonsterId(int avatarMonsterId) {
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams
				.put(DBConstants.USER__AVATAR_MONSTER_ID, avatarMonsterId);
	...
	public boolean updateFreeBoosterPack(int gemChange, Date now, int expDelta) {
		Map<String, Object> conditionParams = new HashMap<String, Object>();
		conditionParams.put(DBConstants.USER__ID, id);
	...
	public boolean updateBoughtBoosterPack(int gemChange, int gachaCreditsChange,
		...
		if (!boughtRiggedBoosterPack && riggedBoosterPack) {
			absoluteParams.put(DBConstants.USER__BOUGHT_RIGGED_BOOSTER_PACK,
					true);
		}
	...
	public boolean updateDefendingMsg(String msg) {
		...
		Map<String, Object> absoluteParams = new HashMap<String, Object>();
		absoluteParams.put(DBConstants.USER__PVP_DEFENDING_MESSAGE, msg);
	...
	public boolean updateGemsCashAndOilFromBattleItem(int gemsDelta,
			int cashDelta, int oilDelta) {
	...
	public void setLastWallPostNotificationTime(
			Date lastWallPostNotificationTime) {
		this.lastWallPostNotificationTime = lastWallPostNotificationTime;
	}
