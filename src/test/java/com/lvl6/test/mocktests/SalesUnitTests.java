...
public class SalesUnitTests {
	...
	public void testCheckIfDuplicateReceipt() {
		iapa.setReceiptFromApple(mockedReceiptFromApple1);
		iapa.setIapHistoryRetrieveUtil(mockedIAPHistoryRetrieveUtil);
		
		assertFalse(iapa.checkIfDuplicateReceipt());
		
		iapa.setReceiptFromApple(mockedReceiptFromApple2);
		assertTrue(iapa.checkIfDuplicateReceipt());
	}
