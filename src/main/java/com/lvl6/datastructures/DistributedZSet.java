...
public interface DistributedZSet {
	 ...
	 * @param key
	 * @param score
	 * Adds a member to the set or replaces score if it already exists
	 */
	 ...
	 * @param key
	 * @param increment
	 * Increments the score for the given key
	 */
	 ...
	 * @param maxIndex
	 * @return
	 * Returns range of members in sorted set, by index
	 */
	 ...
	 * @param maxScore
	 * @return
	 * Returns range of members in sorted set, by score
	 */
	...
	/**
	 * @return
	 * Set is async / eventually consistent. This is useful for unit tests.
	 */
