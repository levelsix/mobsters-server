...
public class PerformResearchRequestEvent extends RequestEvent {
  ...
  public void read(ByteBuffer buff) {
    try {
    	performResearchRequestProto = PerformResearchRequestProto.parseFrom(ByteString.copyFrom(buff));
  ...
  public void setPerformResearchRequestProto( PerformResearchRequestProto performResearchRequestProto )
  {
