...
public class FinishPerformingResearchRequestEvent extends RequestEvent {
  ...
  public void read(ByteBuffer buff) {
    try {
    	finishPerformingResearchRequestProto = FinishPerformingResearchRequestProto.parseFrom(ByteString.copyFrom(buff));
      playerId = finishPerformingResearchRequestProto.getSender().getUserUuid();
  ...
  public void setFinishPerformingResearchRequestProto( FinishPerformingResearchRequestProto finishPerformingResearchRequestProto )
  {
