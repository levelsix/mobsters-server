...
public class RetrieveClanDataResponseEvent extends NormalResponseEvent {
  ...
  public RetrieveClanDataResponseEvent(int playerId){
    super(playerId);
  ...
  public void setRetrieveClanDataResponseProto(RetrieveClanDataResponseProto retrieveClanDataResponseProto) {
