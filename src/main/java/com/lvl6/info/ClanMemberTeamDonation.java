...
public class ClanMemberTeamDonation implements Serializable {
	...
	public ClanMemberTeamDonation(String id, String userId, String clanId,
			int powerLimit, boolean fulfilled, String msg,
	...
	public String toString() {
		return "ClanMemberTeamDonation [id=" + id + ", userId=" + userId
				+ ", clanId=" + clanId + ", powerLimit=" + powerLimit
				+ ", fulfilled=" + fulfilled + ", msg=" + msg
				+ ", timeOfSolicitation=" + timeOfSolicitation + "]";
	}
