...
public class GoldSale implements Serializable {
	...
	public GoldSale(int id, Date startDate, Date endDate,
			String goldShoppeImageName, String goldBarImageName,
			String package1SaleIdentifier, String package2SaleIdentifier,
			String package3SaleIdentifier, String package4SaleIdentifier,
			String package5SaleIdentifier, String packageS1SaleIdentifier,
			String packageS2SaleIdentifier, String packageS3SaleIdentifier,
			String packageS4SaleIdentifier, String packageS5SaleIdentifier,
	...
	public String toString() {
		return "GoldSale [id=" + id + ", startDate=" + startDate + ", endDate="
				+ endDate + ", package1SaleIdentifier="
				+ package1SaleIdentifier + ", package2SaleIdentifier="
				+ package2SaleIdentifier + ", package3SaleIdentifier="
				+ package3SaleIdentifier + ", package4SaleIdentifier="
				+ package4SaleIdentifier + ", package5SaleIdentifier="
				+ package5SaleIdentifier + ", packageS1SaleIdentifier="
				+ packageS1SaleIdentifier + ", packageS2SaleIdentifier="
				+ packageS2SaleIdentifier + ", packageS3SaleIdentifier="
				+ packageS3SaleIdentifier + ", packageS4SaleIdentifier="
				+ packageS4SaleIdentifier + ", packageS5SaleIdentifier="
				+ packageS5SaleIdentifier + ", goldShoppeImageName="
				+ goldShoppeImageName + ", goldBarImageName="
				+ goldBarImageName + "]";
	}
}
