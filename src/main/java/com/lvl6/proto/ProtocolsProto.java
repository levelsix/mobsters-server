...
public final class ProtocolsProto {
  ...
  public enum EventProtocolResponse
    ...
    S_UPDATE_CLIENT_USER_EVENT(58, 101),
    S_REFERRAL_CODE_USED_EVENT(59, 102),
    S_PURGE_STATIC_DATA_EVENT(60, 103),
    S_RECEIVED_GROUP_CHAT_EVENT(61, 104),
    S_SEND_ADMIN_MESSAGE_EVENT(62, 105),
    S_GENERAL_NOTIFICATION_EVENT(63, 106),
    S_RECEIVED_RARE_BOOSTER_PURCHASE_EVENT(64, 107),
    ;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "TTLE_EVENT\020<\022\022\n\016C_LOGOUT_EVENT\020e*\307\021\n\025Eve" +
