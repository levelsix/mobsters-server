...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_SET_GAME_CENTER_ID_EVENT(63, 66),
    C_SPAWN_OBSTACLE_EVENT(64, 67),
    C_BEGIN_OBSTACLE_REMOVAL_EVENT(65, 68),
    C_OBSTACLE_REMOVAL_COMPLETE_EVENT(66, 69),
    C_LOGOUT_EVENT(67, 101),
    ;
  ...
  public enum EventProtocolResponse
    ...
    S_SET_GAME_CENTER_ID_EVENT(63, 66),
    S_SPAWN_OBSTACLE_EVENT(64, 67),
    S_BEGIN_OBSTACLE_REMOVAL_EVENT(65, 68),
    S_OBSTACLE_REMOVAL_COMPLETE_EVENT(66, 69),
    S_UPDATE_CLIENT_USER_EVENT(67, 101),
    S_REFERRAL_CODE_USED_EVENT(68, 102),
    S_PURGE_STATIC_DATA_EVENT(69, 103),
    S_RECEIVED_GROUP_CHAT_EVENT(70, 104),
    S_SEND_ADMIN_MESSAGE_EVENT(71, 105),
    S_GENERAL_NOTIFICATION_EVENT(72, 106),
    S_RECEIVED_RARE_BOOSTER_PURCHASE_EVENT(73, 107),
    S_AWARD_CLAN_RAID_STAGE_REWARD_EVENT(74, 108),
    S_FORCE_LOGOUT_EVENT(75, 109),
    ;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "%\n!C_OBSTACLE_REMOVAL_COMPLETE_EVENT\020E\022\022" +
      "\n\016C_LOGOUT_EVENT\020e*\275\024\n\025EventProtocolResp" +
