...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_PURCHASE_BOOSTER_PACK_EVENT(34, 37),
    C_CHANGE_CLAN_JOIN_TYPE_EVENT(35, 39),
    C_PRIVATE_CHAT_POST_EVENT(36, 40),
    C_RETRIEVE_PRIVATE_CHAT_POST_EVENT(37, 41),
    C_REDEEM_USER_LOCK_BOX_ITEMS_EVENT(38, 42),
    C_BEGIN_DUNGEON_EVENT(39, 43),
    C_END_DUNGEON_EVENT(40, 44),
    C_REVIVE_IN_DUNGEON_EVENT(41, 45),
    C_QUEUE_UP_EVENT(42, 46),
    C_UPDATE_MONSTER_HEALTH_EVENT(43, 47),
    C_HEAL_MONSTER_EVENT(44, 48),
    C_HEAL_MONSTER_WAIT_TIME_COMPLETE_EVENT(45, 49),
  ...
  public enum EventProtocolResponse
    ...
    S_PURCHASE_BOOSTER_PACK_EVENT(34, 37),
    S_CHANGE_CLAN_JOIN_TYPE_EVENT(35, 39),
    S_PRIVATE_CHAT_POST_EVENT(36, 40),
    S_RETRIEVE_PRIVATE_CHAT_POST_EVENT(37, 41),
    S_REDEEM_USER_LOCK_BOX_ITEMS_EVENT(38, 42),
    S_BEGIN_DUNGEON_EVENT(39, 43),
    S_END_DUNGEON_EVENT(40, 44),
    S_REVIVE_IN_DUNGEON_EVENT(41, 45),
    S_QUEUE_UP_EVENT(42, 46),
    S_UPDATE_MONSTER_HEALTH_EVENT(43, 47),
    S_HEAL_MONSTER_EVENT(44, 48),
    S_HEAL_MONSTER_WAIT_TIME_COMPLETE_EVENT(45, 49),
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "VENT\020#\022!\n\035C_PURCHASE_BOOSTER_PACK_EVENT\020" +
      "%\022!\n\035C_CHANGE_CLAN_JOIN_TYPE_EVENT\020\'\022\035\n\031" +
      "C_PRIVATE_CHAT_POST_EVENT\020(\022&\n\"C_RETRIEV" +
      "E_PRIVATE_CHAT_POST_EVENT\020)\022&\n\"C_REDEEM_" +
      "USER_LOCK_BOX_ITEMS_EVENT\020*\022\031\n\025C_BEGIN_D" +
      "UNGEON_EVENT\020+\022\027\n\023C_END_DUNGEON_EVENT\020,\022" +
      "\035\n\031C_REVIVE_IN_DUNGEON_EVENT\020-\022\024\n\020C_QUEU",
      "E_UP_EVENT\020.\022!\n\035C_UPDATE_MONSTER_HEALTH_" +
      "EVENT\020/\022\030\n\024C_HEAL_MONSTER_EVENT\0200\022+\n\'C_H" +
      "EAL_MONSTER_WAIT_TIME_COMPLETE_EVENT\0201\022&" +
      "\n\"C_ADD_MONSTER_TO_BATTLE_TEAM_EVENT\0202\022+" +
      "\n\'C_REMOVE_MONSTER_FROM_BATTLE_TEAM_EVEN" +
      "T\0203\022+\n\'C_INCREASE_MONSTER_INVENTORY_SLOT" +
      "_EVENT\0204\022*\n&C_ENHANCEMENT_WAIT_TIME_COMP" +
      "LETE_EVENT\0205\022\'\n#C_COMBINE_USER_MONSTER_P" +
      "IECES_EVENT\0206\022\035\n\031C_SELL_USER_MONSTER_EVE" +
      "NT\0207\022\'\n#C_INVITE_FB_FRIENDS_FOR_SLOTS_EV",
      "ENT\0208\0221\n-C_ACCEPT_AND_REJECT_FB_INVITE_F" +
      "OR_SLOTS_EVENT\0209\022\022\n\016C_LOGOUT_EVENT\020e*\323\020\n" +
      ...
      "MONSTER_WAIT_TIME_COMPLETE_EVENT\0201\022&\n\"S_" +
