...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_ADD_MONSTER_TO_BATTLE_TEAM_EVENT(47, 50),
    C_REMOVE_MONSTER_FROM_BATTLE_TEAM_EVENT(48, 51),
    C_INCREASE_MONSTER_INVENTORY_SLOT_EVENT(49, 52),
    C_ENHANCEMENT_WAIT_TIME_COMPLETE_EVENT(50, 53),
    C_COMBINE_USER_MONSTER_PIECES_EVENT(51, 54),
    C_SELL_USER_MONSTER_EVENT(52, 55),
    C_INVITE_FB_FRIENDS_FOR_SLOTS_EVENT(53, 56),
    C_ACCEPT_AND_REJECT_FB_INVITE_FOR_SLOTS_EVENT(54, 57),
    C_UPDATE_USER_CURRENCY_EVENT(55, 59),
    C_BEGIN_PVP_BATTLE_EVENT(56, 60),
    C_END_PVP_BATTLE_EVENT(57, 61),
    C_BEGIN_CLAN_RAID_EVENT(58, 62),
    C_ATTACK_CLAN_RAID_MONSTER_EVENT(59, 63),
    C_RECORD_CLAN_RAID_STATS_EVENT(60, 64),
    C_PROMOTE_DEMOTE_CLAN_MEMBER_EVENT(61, 65),
    C_SET_GAME_CENTER_ID_EVENT(62, 66),
    C_SPAWN_OBSTACLE_EVENT(63, 67),
    C_BEGIN_OBSTACLE_REMOVAL_EVENT(64, 68),
    C_OBSTACLE_REMOVAL_COMPLETE_EVENT(65, 69),
  ...
  public enum EventProtocolResponse
    ...
    S_ADD_MONSTER_TO_BATTLE_TEAM_EVENT(47, 50),
    S_REMOVE_MONSTER_FROM_BATTLE_TEAM_EVENT(48, 51),
    S_INCREASE_MONSTER_INVENTORY_SLOT_EVENT(49, 52),
    S_ENHANCEMENT_WAIT_TIME_COMPLETE_EVENT(50, 53),
    S_COMBINE_USER_MONSTER_PIECES_EVENT(51, 54),
    S_SELL_USER_MONSTER_EVENT(52, 55),
    S_INVITE_FB_FRIENDS_FOR_SLOTS_EVENT(53, 56),
    S_ACCEPT_AND_REJECT_FB_INVITE_FOR_SLOTS_EVENT(54, 57),
    S_UPDATE_USER_CURRENCY_EVENT(55, 59),
    S_BEGIN_PVP_BATTLE_EVENT(56, 60),
    S_END_PVP_BATTLE_EVENT(57, 61),
    S_BEGIN_CLAN_RAID_EVENT(58, 62),
    S_ATTACK_CLAN_RAID_MONSTER_EVENT(59, 63),
    S_RECORD_CLAN_RAID_STATS_EVENT(60, 64),
    S_PROMOTE_DEMOTE_CLAN_MEMBER_EVENT(61, 65),
    S_SET_GAME_CENTER_ID_EVENT(62, 66),
    S_SPAWN_OBSTACLE_EVENT(63, 67),
    S_BEGIN_OBSTACLE_REMOVAL_EVENT(64, 68),
    S_OBSTACLE_REMOVAL_COMPLETE_EVENT(65, 69),
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "EVENT\020\025\022\036\n\032C_EARN_FREE_DIAMONDS_EVENT\020\026\022" +
      ...
      "SETTINGS_EVENT\020\037\022!\n\035C_BOOT_PLAYER_FROM_C" +
      "LAN_EVENT\020 \022\031\n\025C_PICK_LOCK_BOX_EVENT\020!\022(" +
      "\n$C_RETRIEVE_TOURNAMENT_RANKINGS_EVENT\020\"" +
      "\022&\n\"C_SUBMIT_MONSTER_ENHANCEMENT_EVENT\020#" +
      "\022\032\n\026C_EVOLVE_MONSTER_EVENT\020$\022!\n\035C_PURCHA" +
      "SE_BOOSTER_PACK_EVENT\020%\022\036\n\032C_EVOLUTION_F" +
      "INISHED_EVENT\020&\022\035\n\031C_PRIVATE_CHAT_POST_E" +
      "VENT\020(\022&\n\"C_RETRIEVE_PRIVATE_CHAT_POST_E" +
      "VENT\020)\022&\n\"C_REDEEM_USER_LOCK_BOX_ITEMS_E" +
      "VENT\020*\022\031\n\025C_BEGIN_DUNGEON_EVENT\020+\022\027\n\023C_E",
      "ND_DUNGEON_EVENT\020,\022\035\n\031C_REVIVE_IN_DUNGEO" +
      "N_EVENT\020-\022\024\n\020C_QUEUE_UP_EVENT\020.\022!\n\035C_UPD" +
      "ATE_MONSTER_HEALTH_EVENT\020/\022\030\n\024C_HEAL_MON" +
      ...
      "CENTER_ID_EVENT\020B\022\032\n\026C_SPAWN_OBSTACLE_EV" +
      "ENT\020C\022\"\n\036C_BEGIN_OBSTACLE_REMOVAL_EVENT\020",
      "D\022%\n!C_OBSTACLE_REMOVAL_COMPLETE_EVENT\020E" +
      "\022\022\n\016C_LOGOUT_EVENT\020e*\227\024\n\025EventProtocolRe" +
      ...
      "T\020%\022\036\n\032S_EVOLUTION_FINISHED_EVENT\020&\022\035\n\031S" +
      ...
      "VAL_COMPLETE_EVENT\020E\022\036\n\032S_UPDATE_CLIENT_" +
      ...
      "VENT\020mB\020B\016ProtocolsProto"
    };
