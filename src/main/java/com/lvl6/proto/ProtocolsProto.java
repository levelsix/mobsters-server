...
public final class ProtocolsProto {
  ...
  public enum EventProtocolRequest
    ...
    C_BEGIN_PVP_BATTLE_EVENT(57, 60),
    C_END_PVP_BATTLE_EVENT(58, 61),
    C_BEGIN_CLAN_RAID_EVENT(59, 62),
    C_ATTACK_CLAN_RAID_MONSTER_EVENT(60, 63),
    C_RECORD_CLAN_RAID_STATS_EVENT(61, 64),
    C_PROMOTE_DEMOTE_CLAN_MEMBER_EVENT(62, 65),
  ...
  public enum EventProtocolResponse
    ...
    S_BEGIN_PVP_BATTLE_EVENT(57, 60),
    S_END_PVP_BATTLE_EVENT(58, 61),
    S_BEGIN_CLAN_RAID_EVENT(59, 62),
    S_ATTACK_CLAN_RAID_MONSTER_EVENT(60, 63),
    S_RECORD_CLAN_RAID_STATS_EVENT(61, 64),
    S_PROMOTE_DEMOTE_CLAN_MEMBER_EVENT(62, 65),
    S_UPDATE_CLIENT_USER_EVENT(63, 101),
    S_REFERRAL_CODE_USED_EVENT(64, 102),
    S_PURGE_STATIC_DATA_EVENT(65, 103),
    S_RECEIVED_GROUP_CHAT_EVENT(66, 104),
    S_SEND_ADMIN_MESSAGE_EVENT(67, 105),
    S_GENERAL_NOTIFICATION_EVENT(68, 106),
    S_RECEIVED_RARE_BOOSTER_PURCHASE_EVENT(69, 107),
    S_AWARD_CLAN_RAID_STAGE_REWARD_EVENT(70, 108),
    ;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "N_FINISHED_EVENT\020&\022!\n\035C_CHANGE_CLAN_JOIN" +
      "_TYPE_EVENT\020\'\022\035\n\031C_PRIVATE_CHAT_POST_EVE" +
      "NT\020(\022&\n\"C_RETRIEVE_PRIVATE_CHAT_POST_EVE" +
      "NT\020)\022&\n\"C_REDEEM_USER_LOCK_BOX_ITEMS_EVE",
      ...
      "OTE_CLAN_MEMBER_EVENT\020A\022\022\n\016C_LOGOUT_EVEN" +
      ...
      "AN_DESCRIPTION_EVENT\020\037\022!\n\035S_BOOT_PLAYER_" +
      "FROM_CLAN_EVENT\020 \022\031\n\025S_PICK_LOCK_BOX_EVE" +
      "NT\020!\022(\n$S_RETRIEVE_TOURNAMENT_RANKINGS_E" +
      "VENT\020\"\022&\n\"S_SUBMIT_MONSTER_ENHANCEMENT_E" +
      "VENT\020#\022\032\n\026S_EVOLVE_MONSTER_EVENT\020$\022!\n\035S_",
      "PURCHASE_BOOSTER_PACK_EVENT\020%\022\036\n\032S_EVOLU" +
      "TION_FINISHED_EVENT\020&\022!\n\035S_CHANGE_CLAN_J" +
      ...
      "_RAID_STAGE_REWARD_EVENT\020lB\020B\016ProtocolsP" +
      "roto"
    };
