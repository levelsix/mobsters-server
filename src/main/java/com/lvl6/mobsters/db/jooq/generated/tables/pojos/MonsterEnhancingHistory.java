...
public class MonsterEnhancingHistory implements IMonsterEnhancingHistory {

	private static final long serialVersionUID = -76922570;
	...
	public MonsterEnhancingHistory(MonsterEnhancingHistory value) {
		this.id = value.id;
	...
	@Override
	public MonsterEnhancingHistory setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setMfuIdBeingEnhanced(String mfuIdBeingEnhanced) {
		this.mfuIdBeingEnhanced = mfuIdBeingEnhanced;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setFeederMfuId(String feederMfuId) {
		this.feederMfuId = feederMfuId;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setCurrentExperience(Integer currentExperience) {
		this.currentExperience = currentExperience;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setPreviousExperience(Integer previousExperience) {
		this.previousExperience = previousExperience;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setEnhancingStartTime(Timestamp enhancingStartTime) {
		this.enhancingStartTime = enhancingStartTime;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setTimeOfEntry(Timestamp timeOfEntry) {
		this.timeOfEntry = timeOfEntry;
		return this;
	}
	...
	@Override
	public MonsterEnhancingHistory setEnhancingCost(Integer enhancingCost) {
		this.enhancingCost = enhancingCost;
		return this;
	}
