...
public class StructureConfig implements IStructureConfig {

	private static final long serialVersionUID = 367686395;
	...
	private UInteger buildCost;
	private UInteger minutesToBuild;
	private UInteger width;
	private UInteger height;
	private UInteger predecessorStructId;
	private UInteger successorStructId;
	...
	public StructureConfig(StructureConfig value) {
		this.id = value.id;
	...
	public StructureConfig(
		...
		UInteger buildCost,
		UInteger minutesToBuild,
		UInteger width,
		UInteger height,
		UInteger predecessorStructId,
		UInteger successorStructId,
		String   imgName,
	...
	@Override
	public StructureConfig setId(UInteger id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public StructureConfig setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public StructureConfig setLevel(UByte level) {
		this.level = level;
		return this;
	}
	...
	@Override
	public StructureConfig setStructType(String structType) {
		this.structType = structType;
		return this;
	}
	...
	@Override
	public StructureConfig setBuildResourceType(String buildResourceType) {
		this.buildResourceType = buildResourceType;
		return this;
	}
	...
	@Override
	public StructureConfig setBuildCost(UInteger buildCost) {
		this.buildCost = buildCost;
		return this;
	}
	...
	@Override
	public StructureConfig setMinutesToBuild(UInteger minutesToBuild) {
		this.minutesToBuild = minutesToBuild;
		return this;
	}
	...
	@Override
	public StructureConfig setWidth(UInteger width) {
		this.width = width;
		return this;
	}
	...
	@Override
	public StructureConfig setHeight(UInteger height) {
		this.height = height;
		return this;
	}
	...
	@Override
	public StructureConfig setPredecessorStructId(UInteger predecessorStructId) {
		this.predecessorStructId = predecessorStructId;
		return this;
	}
	...
	@Override
	public StructureConfig setSuccessorStructId(UInteger successorStructId) {
		this.successorStructId = successorStructId;
		return this;
	}
	...
	@Override
	public StructureConfig setImgName(String imgName) {
		this.imgName = imgName;
		return this;
	}
	...
	@Override
	public StructureConfig setImgVerticalPixelOffset(Double imgVerticalPixelOffset) {
		this.imgVerticalPixelOffset = imgVerticalPixelOffset;
		return this;
	}
	...
	@Override
	public StructureConfig setImgHorizontalPixelOffset(Double imgHorizontalPixelOffset) {
		this.imgHorizontalPixelOffset = imgHorizontalPixelOffset;
		return this;
	}
	...
	@Override
	public StructureConfig setDescription(String description) {
		this.description = description;
		return this;
	}
	...
	@Override
	public StructureConfig setShortDescription(String shortDescription) {
		this.shortDescription = shortDescription;
		return this;
	}
	...
	@Override
	public StructureConfig setShadowImgName(String shadowImgName) {
		this.shadowImgName = shadowImgName;
		return this;
	}
	...
	@Override
	public StructureConfig setShadowVerticalOffset(Double shadowVerticalOffset) {
		this.shadowVerticalOffset = shadowVerticalOffset;
		return this;
	}
	...
	@Override
	public StructureConfig setShadowHorizontalOffset(Double shadowHorizontalOffset) {
		this.shadowHorizontalOffset = shadowHorizontalOffset;
		return this;
	}
	...
	@Override
	public StructureConfig setShadowScale(Double shadowScale) {
		this.shadowScale = shadowScale;
		return this;
	}
	...
	@Override
	public StructureConfig setExpReward(Integer expReward) {
		this.expReward = expReward;
		return this;
	}
	...
	@Override
	public StructureConfig setStrength(Integer strength) {
		this.strength = strength;
		return this;
	}
