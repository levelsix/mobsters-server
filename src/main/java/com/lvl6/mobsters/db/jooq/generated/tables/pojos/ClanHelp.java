...
public class ClanHelp implements IClanHelp {

	private static final long serialVersionUID = -463665777;
	...
	public ClanHelp(ClanHelp value) {
		this.id = value.id;
	...
	@Override
	public ClanHelp setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanHelp setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ClanHelp setUserDataId(String userDataId) {
		this.userDataId = userDataId;
		return this;
	}
	...
	@Override
	public ClanHelp setHelpType(String helpType) {
		this.helpType = helpType;
		return this;
	}
	...
	@Override
	public ClanHelp setClanId(String clanId) {
		this.clanId = clanId;
		return this;
	}
	...
	@Override
	public ClanHelp setTimeOfEntry(Timestamp timeOfEntry) {
		this.timeOfEntry = timeOfEntry;
		return this;
	}
	...
	@Override
	public ClanHelp setMaxHelpers(Integer maxHelpers) {
		this.maxHelpers = maxHelpers;
		return this;
	}
	...
	@Override
	public ClanHelp setHelpers(String helpers) {
		this.helpers = helpers;
		return this;
	}
	...
	@Override
	public ClanHelp setOpen(Boolean open) {
		this.open = open;
		return this;
	}
	...
	@Override
	public ClanHelp setStaticDataId(Integer staticDataId) {
		this.staticDataId = staticDataId;
		return this;
	}
