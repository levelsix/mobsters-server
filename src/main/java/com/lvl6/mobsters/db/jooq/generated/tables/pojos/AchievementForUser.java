...
public class AchievementForUser implements IAchievementForUser {

	private static final long serialVersionUID = 1181716022;
	...
	public AchievementForUser(AchievementForUser value) {
	...
	@Override
	public AchievementForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public AchievementForUser setAchievementId(Integer achievementId) {
		this.achievementId = achievementId;
		return this;
	}
	...
	@Override
	public AchievementForUser setProgress(Integer progress) {
		this.progress = progress;
		return this;
	}
	...
	@Override
	public AchievementForUser setIsComplete(Boolean isComplete) {
		this.isComplete = isComplete;
		return this;
	}
	...
	@Override
	public AchievementForUser setTimeCompleted(Timestamp timeCompleted) {
		this.timeCompleted = timeCompleted;
		return this;
	}
	...
	@Override
	public AchievementForUser setIsRedeemed(Boolean isRedeemed) {
		this.isRedeemed = isRedeemed;
		return this;
	}
	...
	@Override
	public AchievementForUser setTimeRedeemed(Timestamp timeRedeemed) {
		this.timeRedeemed = timeRedeemed;
		return this;
	}
