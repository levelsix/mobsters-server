...
public class EventPersistentConfig implements IEventPersistentConfig {
	...
	private static final long serialVersionUID = -774818607;

	private Integer  id;
	private String   dayOfWeek;
	private UByte    startHour;
	private UInteger eventDurationMinutes;
	private UInteger taskId;
	private UInteger cooldownMinutes;
	...
	@Override
	public EventPersistentConfig setStartHour(UByte startHour) {
		this.startHour = startHour;
		return this;
	}
	...
	@Override
	public EventPersistentConfig setEventDurationMinutes(UInteger eventDurationMinutes) {
		this.eventDurationMinutes = eventDurationMinutes;
		return this;
	}
	...
	@Override
	public EventPersistentConfig setTaskId(UInteger taskId) {
		this.taskId = taskId;
		return this;
	}
	...
	@Override
	public EventPersistentConfig setCooldownMinutes(UInteger cooldownMinutes) {
		this.cooldownMinutes = cooldownMinutes;
		return this;
	}
