...
public class MonsterForUserDeleted implements IMonsterForUserDeleted {
	...
	private static final long serialVersionUID = 413377044;

	private String    monsterForUserId;
	private String    userId;
	private UInteger  monsterId;
	private UInteger  currentExperience;
	private UByte     currentLevel;
	private UInteger  currentHealth;
	private UByte     numPieces;
	private Boolean   isComplete;
	private Timestamp combineStartTime;
	private UByte     teamSlotNum;
	...
	public MonsterForUserDeleted(
		...
		String    userId,
		UInteger  monsterId,
		UInteger  currentExperience,
		UByte     currentLevel,
		UInteger  currentHealth,
		UByte     numPieces,
		Boolean   isComplete,
	...
	@Override
	public MonsterForUserDeleted setMonsterId(UInteger monsterId) {
		this.monsterId = monsterId;
		return this;
	}
	...
	@Override
	public MonsterForUserDeleted setCurrentExperience(UInteger currentExperience) {
		this.currentExperience = currentExperience;
		return this;
	}
	...
	@Override
	public MonsterForUserDeleted setCurrentLevel(UByte currentLevel) {
		this.currentLevel = currentLevel;
		return this;
	}
	...
	@Override
	public MonsterForUserDeleted setCurrentHealth(UInteger currentHealth) {
		this.currentHealth = currentHealth;
		return this;
	}
	...
	@Override
	public MonsterForUserDeleted setNumPieces(UByte numPieces) {
		this.numPieces = numPieces;
		return this;
	}
	...
	@Override
	public MonsterForUserDeleted setTeamSlotNum(UByte teamSlotNum) {
		this.teamSlotNum = teamSlotNum;
		return this;
	}
