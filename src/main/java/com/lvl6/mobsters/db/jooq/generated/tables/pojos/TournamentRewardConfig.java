...
public class TournamentRewardConfig implements ITournamentRewardConfig {

	private static final long serialVersionUID = -214976774;
	...
	public TournamentRewardConfig(TournamentRewardConfig value) {
		this.id = value.id;
	...
	@Override
	public TournamentRewardConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setMinRank(Integer minRank) {
		this.minRank = minRank;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setMaxRank(Integer maxRank) {
		this.maxRank = maxRank;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setGoldRewarded(Integer goldRewarded) {
		this.goldRewarded = goldRewarded;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setBackgroundImageName(String backgroundImageName) {
		this.backgroundImageName = backgroundImageName;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setPrizeImageName(String prizeImageName) {
		this.prizeImageName = prizeImageName;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setBlue(Integer blue) {
		this.blue = blue;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setGreen(Integer green) {
		this.green = green;
		return this;
	}
	...
	@Override
	public TournamentRewardConfig setRed(Integer red) {
		this.red = red;
		return this;
	}
