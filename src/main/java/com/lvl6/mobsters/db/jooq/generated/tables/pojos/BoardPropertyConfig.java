...
public class BoardPropertyConfig implements IBoardPropertyConfig {

	private static final long serialVersionUID = -1341180755;
	...
	public BoardPropertyConfig(BoardPropertyConfig value) {
		this.id = value.id;
	...
	@Override
	public BoardPropertyConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setBoardId(Integer boardId) {
		this.boardId = boardId;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setPosX(UByte posX) {
		this.posX = posX;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setPosY(UByte posY) {
		this.posY = posY;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setElement(String element) {
		this.element = element;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setValue(UInteger value) {
		this.value = value;
		return this;
	}
	...
	@Override
	public BoardPropertyConfig setQuantity(Integer quantity) {
		this.quantity = quantity;
		return this;
	}
