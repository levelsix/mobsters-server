...
public class StaticLevelInfoConfig implements IStaticLevelInfoConfig {

	private static final long serialVersionUID = -1179522639;
	...
	public StaticLevelInfoConfig(StaticLevelInfoConfig value) {
	...
	@Override
	public StaticLevelInfoConfig setLevelId(Integer levelId) {
		this.levelId = levelId;
		return this;
	}
	...
	@Override
	public StaticLevelInfoConfig setRequiredExperience(Integer requiredExperience) {
		this.requiredExperience = requiredExperience;
		return this;
	}
