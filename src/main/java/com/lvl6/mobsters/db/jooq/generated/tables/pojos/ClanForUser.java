...
public class ClanForUser implements IClanForUser {

	private static final long serialVersionUID = -1631262216;
	...
	public ClanForUser(ClanForUser value) {
	...
	@Override
	public ClanForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ClanForUser setClanId(String clanId) {
		this.clanId = clanId;
		return this;
	}
	...
	@Override
	public ClanForUser setStatus(String status) {
		this.status = status;
		return this;
	}
	...
	@Override
	public ClanForUser setRequestTime(Timestamp requestTime) {
		this.requestTime = requestTime;
		return this;
	}
