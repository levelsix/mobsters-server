...
public class QuestConfig implements IQuestConfig {

	private static final long serialVersionUID = 749742053;
	...
	public QuestConfig(QuestConfig value) {
		this.id = value.id;
	...
	@Override
	public QuestConfig setId(UInteger id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public QuestConfig setQuestName(String questName) {
		this.questName = questName;
		return this;
	}
	...
	@Override
	public QuestConfig setDoneResponse(String doneResponse) {
		this.doneResponse = doneResponse;
		return this;
	}
	...
	@Override
	public QuestConfig setAcceptDialogue(String acceptDialogue) {
		this.acceptDialogue = acceptDialogue;
		return this;
	}
	...
	@Override
	public QuestConfig setCashReward(Integer cashReward) {
		this.cashReward = cashReward;
		return this;
	}
	...
	@Override
	public QuestConfig setOilReward(Integer oilReward) {
		this.oilReward = oilReward;
		return this;
	}
	...
	@Override
	public QuestConfig setGemReward(Integer gemReward) {
		this.gemReward = gemReward;
		return this;
	}
	...
	@Override
	public QuestConfig setExpReward(Integer expReward) {
		this.expReward = expReward;
		return this;
	}
	...
	@Override
	public QuestConfig setMonsterIdReward(Integer monsterIdReward) {
		this.monsterIdReward = monsterIdReward;
		return this;
	}
	...
	@Override
	public QuestConfig setIsCompleteMonster(Boolean isCompleteMonster) {
		this.isCompleteMonster = isCompleteMonster;
		return this;
	}
	...
	@Override
	public QuestConfig setQuestsRequiredForThis(String questsRequiredForThis) {
		this.questsRequiredForThis = questsRequiredForThis;
		return this;
	}
	...
	@Override
	public QuestConfig setQuestGiverName(String questGiverName) {
		this.questGiverName = questGiverName;
		return this;
	}
	...
	@Override
	public QuestConfig setQuestGiverImagePrefix(String questGiverImagePrefix) {
		this.questGiverImagePrefix = questGiverImagePrefix;
		return this;
	}
	...
	@Override
	public QuestConfig setPriority(Integer priority) {
		this.priority = priority;
		return this;
	}
	...
	@Override
	public QuestConfig setCarrotId(String carrotId) {
		this.carrotId = carrotId;
		return this;
	}
	...
	@Override
	public QuestConfig setMonsterElement(String monsterElement) {
		this.monsterElement = monsterElement;
		return this;
	}
