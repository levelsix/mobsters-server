...
public class MiniJobConfig implements IMiniJobConfig {

	private static final long serialVersionUID = 951400807;

	private Integer  id;
	private Integer  requiredStructId;
	private String   name;
	private UInteger cashReward;
	private UInteger oilReward;
	private UInteger gemReward;
	private UInteger monsterIdReward;
	...
	private UByte    maxNumMonstersAllowed;
	private Double   chanceToAppear;
	private Integer  hpRequired;
	private UInteger atkRequired;
	private UInteger minDmg;
	private UInteger maxDmg;
	private UInteger durationMinMinutes;
	private UInteger durationMaxMinutes;
	...
	public MiniJobConfig(MiniJobConfig value) {
		this.id = value.id;
	...
	public MiniJobConfig(
		...
		UInteger oilReward,
		UInteger gemReward,
		UInteger monsterIdReward,
		Integer  itemIdReward,
		Integer  itemRewardQuantity,
		Integer  secondItemIdReward,
		Integer  secondItemRewardQuantity,
		String   quality,
		UByte    maxNumMonstersAllowed,
		Double   chanceToAppear,
		Integer  hpRequired,
		UInteger atkRequired,
		UInteger minDmg,
		UInteger maxDmg,
		UInteger durationMinMinutes,
		UInteger durationMaxMinutes,
		Boolean  isValid,
		Integer  expReward,
		Integer  rewardIdOne,
		Integer  rewardIdTwo,
	...
	@Override
	public MiniJobConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MiniJobConfig setRequiredStructId(Integer requiredStructId) {
		this.requiredStructId = requiredStructId;
		return this;
	}
	...
	@Override
	public MiniJobConfig setName(String name) {
		this.name = name;
		return this;
	}
	...
	@Override
	public MiniJobConfig setCashReward(UInteger cashReward) {
		this.cashReward = cashReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setOilReward(UInteger oilReward) {
		this.oilReward = oilReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setGemReward(UInteger gemReward) {
		this.gemReward = gemReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setMonsterIdReward(UInteger monsterIdReward) {
		this.monsterIdReward = monsterIdReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setItemIdReward(Integer itemIdReward) {
		this.itemIdReward = itemIdReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setItemRewardQuantity(Integer itemRewardQuantity) {
		this.itemRewardQuantity = itemRewardQuantity;
		return this;
	}
	...
	@Override
	public MiniJobConfig setSecondItemIdReward(Integer secondItemIdReward) {
		this.secondItemIdReward = secondItemIdReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setSecondItemRewardQuantity(Integer secondItemRewardQuantity) {
		this.secondItemRewardQuantity = secondItemRewardQuantity;
		return this;
	}
	...
	@Override
	public MiniJobConfig setQuality(String quality) {
		this.quality = quality;
		return this;
	}
	...
	@Override
	public MiniJobConfig setMaxNumMonstersAllowed(UByte maxNumMonstersAllowed) {
		this.maxNumMonstersAllowed = maxNumMonstersAllowed;
		return this;
	}
	...
	@Override
	public MiniJobConfig setChanceToAppear(Double chanceToAppear) {
		this.chanceToAppear = chanceToAppear;
		return this;
	}
	...
	@Override
	public MiniJobConfig setHpRequired(Integer hpRequired) {
		this.hpRequired = hpRequired;
		return this;
	}
	...
	@Override
	public MiniJobConfig setAtkRequired(UInteger atkRequired) {
		this.atkRequired = atkRequired;
		return this;
	}
	...
	@Override
	public MiniJobConfig setMinDmg(UInteger minDmg) {
		this.minDmg = minDmg;
		return this;
	}
	...
	@Override
	public MiniJobConfig setMaxDmg(UInteger maxDmg) {
		this.maxDmg = maxDmg;
		return this;
	}
	...
	@Override
	public MiniJobConfig setDurationMinMinutes(UInteger durationMinMinutes) {
		this.durationMinMinutes = durationMinMinutes;
		return this;
	}
	...
	@Override
	public MiniJobConfig setDurationMaxMinutes(UInteger durationMaxMinutes) {
		this.durationMaxMinutes = durationMaxMinutes;
		return this;
	}
	...
	@Override
	public MiniJobConfig setIsValid(Boolean isValid) {
		this.isValid = isValid;
		return this;
	}
	...
	@Override
	public MiniJobConfig setExpReward(Integer expReward) {
		this.expReward = expReward;
		return this;
	}
	...
	@Override
	public MiniJobConfig setRewardIdOne(Integer rewardIdOne) {
		this.rewardIdOne = rewardIdOne;
		return this;
	}
	...
	@Override
	public MiniJobConfig setRewardIdTwo(Integer rewardIdTwo) {
		this.rewardIdTwo = rewardIdTwo;
		return this;
	}
	...
	@Override
	public MiniJobConfig setRewardIdThree(Integer rewardIdThree) {
		this.rewardIdThree = rewardIdThree;
		return this;
	}
