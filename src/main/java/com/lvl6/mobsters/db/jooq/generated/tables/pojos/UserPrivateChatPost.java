...
public class UserPrivateChatPost implements IUserPrivateChatPost {

	private static final long serialVersionUID = 251125098;
	...
	public UserPrivateChatPost(UserPrivateChatPost value) {
		this.id = value.id;
	...
	@Override
	public UserPrivateChatPost setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public UserPrivateChatPost setPosterId(String posterId) {
		this.posterId = posterId;
		return this;
	}
	...
	@Override
	public UserPrivateChatPost setRecipientId(String recipientId) {
		this.recipientId = recipientId;
		return this;
	}
	...
	@Override
	public UserPrivateChatPost setTimeOfPost(Timestamp timeOfPost) {
		this.timeOfPost = timeOfPost;
		return this;
	}
	...
	@Override
	public UserPrivateChatPost setContent(String content) {
		this.content = content;
		return this;
	}
	...
	@Override
	public UserPrivateChatPost setContentLanguage(String contentLanguage) {
		this.contentLanguage = contentLanguage;
		return this;
	}
