...
public class ExpansionCostConfig implements IExpansionCostConfig {

	private static final long serialVersionUID = -301271305;
	...
	public ExpansionCostConfig(ExpansionCostConfig value) {
		this.id = value.id;
	...
	@Override
	public ExpansionCostConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ExpansionCostConfig setExpansionCostCash(Integer expansionCostCash) {
		this.expansionCostCash = expansionCostCash;
		return this;
	}
	...
	@Override
	public ExpansionCostConfig setNumMinutesToExpand(Integer numMinutesToExpand) {
		this.numMinutesToExpand = numMinutesToExpand;
		return this;
	}
	...
	@Override
	public ExpansionCostConfig setSpeedupExpansionGemCost(Integer speedupExpansionGemCost) {
		this.speedupExpansionGemCost = speedupExpansionGemCost;
		return this;
	}
