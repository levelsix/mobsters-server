...
public class ClanIconConfig implements IClanIconConfig {

	private static final long serialVersionUID = -2018632405;
	...
	public ClanIconConfig(ClanIconConfig value) {
		this.id = value.id;
	...
	@Override
	public ClanIconConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ClanIconConfig setImgName(String imgName) {
		this.imgName = imgName;
		return this;
	}
	...
	@Override
	public ClanIconConfig setIsAvailable(Boolean isAvailable) {
		this.isAvailable = isAvailable;
		return this;
	}
