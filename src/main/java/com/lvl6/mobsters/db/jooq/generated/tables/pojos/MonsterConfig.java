...
public class MonsterConfig implements IMonsterConfig {
	...
	private static final long serialVersionUID = -1084205332;

	private Integer  id;
	private String   evolutionGroup;
	private String   monsterGroup;
	private String   quality;
	private UByte    evolutionLevel;
	private String   displayName;
	private String   element;
	private String   imagePrefix;
	private UByte    numPuzzlePieces;
	private UInteger minutesToCombinePieces;
	private UByte    maxLevel;
	private Integer  evolutionMonsterId;
	private UInteger evolutionCatalystMonsterId;
	private UInteger minutesToEvolve;
	private UByte    numEvolutionCatalysts;
	...
	public MonsterConfig(MonsterConfig value) {
		this.id = value.id;
	...
	public MonsterConfig(
		...
		String   monsterGroup,
		String   quality,
		UByte    evolutionLevel,
		String   displayName,
		String   element,
		String   imagePrefix,
		UByte    numPuzzlePieces,
		UInteger minutesToCombinePieces,
		UByte    maxLevel,
		Integer  evolutionMonsterId,
		UInteger evolutionCatalystMonsterId,
		UInteger minutesToEvolve,
		UByte    numEvolutionCatalysts,
	...
	@Override
	public MonsterConfig setId(Integer id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public MonsterConfig setEvolutionGroup(String evolutionGroup) {
		this.evolutionGroup = evolutionGroup;
		return this;
	}
	...
	@Override
	public MonsterConfig setMonsterGroup(String monsterGroup) {
		this.monsterGroup = monsterGroup;
		return this;
	}
	...
	@Override
	public MonsterConfig setQuality(String quality) {
		this.quality = quality;
		return this;
	}
	...
	@Override
	public MonsterConfig setEvolutionLevel(UByte evolutionLevel) {
		this.evolutionLevel = evolutionLevel;
		return this;
	}
	...
	@Override
	public MonsterConfig setDisplayName(String displayName) {
		this.displayName = displayName;
		return this;
	}
	...
	@Override
	public MonsterConfig setElement(String element) {
		this.element = element;
		return this;
	}
	...
	@Override
	public MonsterConfig setImagePrefix(String imagePrefix) {
		this.imagePrefix = imagePrefix;
		return this;
	}
	...
	@Override
	public MonsterConfig setNumPuzzlePieces(UByte numPuzzlePieces) {
		this.numPuzzlePieces = numPuzzlePieces;
		return this;
	}
	...
	@Override
	public MonsterConfig setMinutesToCombinePieces(UInteger minutesToCombinePieces) {
		this.minutesToCombinePieces = minutesToCombinePieces;
		return this;
	}
	...
	@Override
	public MonsterConfig setMaxLevel(UByte maxLevel) {
		this.maxLevel = maxLevel;
		return this;
	}
	...
	@Override
	public MonsterConfig setEvolutionMonsterId(Integer evolutionMonsterId) {
		this.evolutionMonsterId = evolutionMonsterId;
		return this;
	}
	...
	@Override
	public MonsterConfig setEvolutionCatalystMonsterId(UInteger evolutionCatalystMonsterId) {
		this.evolutionCatalystMonsterId = evolutionCatalystMonsterId;
		return this;
	}
	...
	@Override
	public MonsterConfig setMinutesToEvolve(UInteger minutesToEvolve) {
		this.minutesToEvolve = minutesToEvolve;
		return this;
	}
	...
	@Override
	public MonsterConfig setNumEvolutionCatalysts(UByte numEvolutionCatalysts) {
		this.numEvolutionCatalysts = numEvolutionCatalysts;
		return this;
	}
	...
	@Override
	public MonsterConfig setCarrotRecruited(String carrotRecruited) {
		this.carrotRecruited = carrotRecruited;
		return this;
	}
	...
	@Override
	public MonsterConfig setCarrotDefeated(String carrotDefeated) {
		this.carrotDefeated = carrotDefeated;
		return this;
	}
	...
	@Override
	public MonsterConfig setCarrotEvolved(String carrotEvolved) {
		this.carrotEvolved = carrotEvolved;
		return this;
	}
	...
	@Override
	public MonsterConfig setDescription(String description) {
		this.description = description;
		return this;
	}
	...
	@Override
	public MonsterConfig setEvolutionCost(String evolutionCost) {
		this.evolutionCost = evolutionCost;
		return this;
	}
	...
	@Override
	public MonsterConfig setAnimationType(String animationType) {
		this.animationType = animationType;
		return this;
	}
	...
	@Override
	public MonsterConfig setVerticalPixelOffset(Integer verticalPixelOffset) {
		this.verticalPixelOffset = verticalPixelOffset;
		return this;
	}
	...
	@Override
	public MonsterConfig setAtkSoundFile(String atkSoundFile) {
		this.atkSoundFile = atkSoundFile;
		return this;
	}
	...
	@Override
	public MonsterConfig setAtkSoundAnimationFrame(Integer atkSoundAnimationFrame) {
		this.atkSoundAnimationFrame = atkSoundAnimationFrame;
		return this;
	}
	...
	@Override
	public MonsterConfig setAtkAnimationRepeatedFramesStart(Integer atkAnimationRepeatedFramesStart) {
		this.atkAnimationRepeatedFramesStart = atkAnimationRepeatedFramesStart;
		return this;
	}
	...
	@Override
	public MonsterConfig setAtkAnimationRepeatedFramesEnd(Integer atkAnimationRepeatedFramesEnd) {
		this.atkAnimationRepeatedFramesEnd = atkAnimationRepeatedFramesEnd;
		return this;
	}
	...
	@Override
	public MonsterConfig setShortName(String shortName) {
		this.shortName = shortName;
		return this;
	}
	...
	@Override
	public MonsterConfig setShadowScaleFactor(Double shadowScaleFactor) {
		this.shadowScaleFactor = shadowScaleFactor;
		return this;
	}
	...
	@Override
	public MonsterConfig setBaseOffensiveSkillId(Integer baseOffensiveSkillId) {
		this.baseOffensiveSkillId = baseOffensiveSkillId;
		return this;
	}
	...
	@Override
	public MonsterConfig setBaseDefensiveSkillId(Integer baseDefensiveSkillId) {
		this.baseDefensiveSkillId = baseDefensiveSkillId;
		return this;
	}
	...
	@Override
	public MonsterConfig setPvpMonsterDropId(Integer pvpMonsterDropId) {
		this.pvpMonsterDropId = pvpMonsterDropId;
		return this;
	}
