...
public class AchievementConfigDao extends DAOImpl<AchievementConfigRecord, com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig, Integer> {

	/**
	 * Create a new AchievementConfigDao without any configuration
	 */
	public AchievementConfigDao() {
		super(AchievementConfig.ACHIEVEMENT_CONFIG, com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig.class);
	}
	...
	public AchievementConfigDao(Configuration configuration) {
		super(AchievementConfig.ACHIEVEMENT_CONFIG, com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig.class, configuration);
	}
	 ...
	 */
	@Override
	protected Integer getId(com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig object) {
		return object.getId();
	}
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchById(Integer... values) {
	 ...
	 */
	public com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig fetchOneById(Integer value) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByName(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByDescription(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByGemReward(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByAchievementType(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByResourceType(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByMonsterElement(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByMonsterQuality(String... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByStaticDataId(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByQuantity(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByPriority(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByPrerequisiteId(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchBySuccessorId(Integer... values) {
	 ...
	 */
	public List<com.lvl6.mobsters.db.jooq.generated.tables.pojos.AchievementConfig> fetchByExpReward(Integer... values) {
