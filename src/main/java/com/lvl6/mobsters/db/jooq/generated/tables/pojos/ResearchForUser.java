...
public class ResearchForUser implements IResearchForUser {

	private static final long serialVersionUID = 1418505184;
	...
	public ResearchForUser(ResearchForUser value) {
		this.id = value.id;
	...
	@Override
	public ResearchForUser setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public ResearchForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public ResearchForUser setResearchId(Integer researchId) {
		this.researchId = researchId;
		return this;
	}
	...
	@Override
	public ResearchForUser setTimePurchased(Timestamp timePurchased) {
		this.timePurchased = timePurchased;
		return this;
	}
	...
	@Override
	public ResearchForUser setIsComplete(Boolean isComplete) {
		this.isComplete = isComplete;
		return this;
	}
