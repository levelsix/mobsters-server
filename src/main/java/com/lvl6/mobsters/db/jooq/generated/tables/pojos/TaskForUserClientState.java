...
public class TaskForUserClientState implements ITaskForUserClientState {

	private static final long serialVersionUID = 1888771646;
	...
	public TaskForUserClientState(TaskForUserClientState value) {
	...
	@Override
	public TaskForUserClientState setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public TaskForUserClientState setClientState(byte[] clientState) {
		this.clientState = clientState;
		return this;
	}
