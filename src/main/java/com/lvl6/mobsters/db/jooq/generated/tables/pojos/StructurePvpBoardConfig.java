...
public class StructurePvpBoardConfig implements IStructurePvpBoardConfig {

	private static final long serialVersionUID = -1663503491;
	...
	public StructurePvpBoardConfig(StructurePvpBoardConfig value) {
	...
	@Override
	public StructurePvpBoardConfig setStructId(Integer structId) {
		this.structId = structId;
		return this;
	}
	...
	@Override
	public StructurePvpBoardConfig setPowerLimit(Integer powerLimit) {
		this.powerLimit = powerLimit;
		return this;
	}
