...
public class TaskConfig implements ITaskConfig {
	...
	private static final long serialVersionUID = 1571967363;
	...
	private UInteger prerequisiteTaskId;
	private UInteger prerequisiteQuestId;
	...
	public TaskConfig(
		...
		UInteger prerequisiteTaskId,
		UInteger prerequisiteQuestId,
		Integer  boardWidth,
		Integer  boardHeight,
	...
	@Override
	public TaskConfig setId(UInteger id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public TaskConfig setPrerequisiteTaskId(UInteger prerequisiteTaskId) {
		this.prerequisiteTaskId = prerequisiteTaskId;
		return this;
	}
	...
	@Override
	public TaskConfig setPrerequisiteQuestId(UInteger prerequisiteQuestId) {
		this.prerequisiteQuestId = prerequisiteQuestId;
		return this;
	}
