...
public class MonsterEnhancingForUser implements IMonsterEnhancingForUser {

	private static final long serialVersionUID = -660977656;
	...
	public MonsterEnhancingForUser(MonsterEnhancingForUser value) {
	...
	@Override
	public MonsterEnhancingForUser setUserId(String userId) {
		this.userId = userId;
		return this;
	}
	...
	@Override
	public MonsterEnhancingForUser setMonsterForUserId(String monsterForUserId) {
		this.monsterForUserId = monsterForUserId;
		return this;
	}
	...
	@Override
	public MonsterEnhancingForUser setExpectedStartTime(Timestamp expectedStartTime) {
		this.expectedStartTime = expectedStartTime;
		return this;
	}
	...
	@Override
	public MonsterEnhancingForUser setEnhancingCost(Integer enhancingCost) {
		this.enhancingCost = enhancingCost;
		return this;
	}
	...
	@Override
	public MonsterEnhancingForUser setEnhancingComplete(Boolean enhancingComplete) {
		this.enhancingComplete = enhancingComplete;
		return this;
	}
