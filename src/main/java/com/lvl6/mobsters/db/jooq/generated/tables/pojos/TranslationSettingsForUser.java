...
public class TranslationSettingsForUser implements ITranslationSettingsForUser {

	private static final long serialVersionUID = 1578756606;
	...
	public TranslationSettingsForUser(TranslationSettingsForUser value) {
		this.id = value.id;
	...
	@Override
	public TranslationSettingsForUser setId(String id) {
		this.id = id;
		return this;
	}
	...
	@Override
	public TranslationSettingsForUser setReceiverUserId(String receiverUserId) {
		this.receiverUserId = receiverUserId;
		return this;
	}
	...
	@Override
	public TranslationSettingsForUser setSenderUserId(String senderUserId) {
		this.senderUserId = senderUserId;
		return this;
	}
	...
	@Override
	public TranslationSettingsForUser setLanguage(String language) {
		this.language = language;
		return this;
	}
	...
	@Override
	public TranslationSettingsForUser setChatType(String chatType) {
		this.chatType = chatType;
		return this;
	}
	...
	@Override
	public TranslationSettingsForUser setTranslationsOn(Boolean translationsOn) {
		this.translationsOn = translationsOn;
		return this;
	}
