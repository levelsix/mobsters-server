...
//	}
//
//	protected void sendMessageToPlayer(ResponseEvent event, ByteBuffer buff, String playerId) {
...
//	    List<String> userIdsInClan = RetrieveUtils.userClanRetrieveUtils()
//	    		.getUserIdsWithStatuses(clanId, statuses);
//	    
//		for (String userId : userIdsInClan) {
