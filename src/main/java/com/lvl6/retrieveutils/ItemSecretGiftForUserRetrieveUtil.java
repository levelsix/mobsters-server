...
public class ItemSecretGiftForUserRetrieveUtil {
	...
	{
		Map<String, ItemSecretGiftForUser> idToUserItemSecretGifts = 
			new HashMap<String, ItemSecretGiftForUser>();	
		Collection<ItemSecretGiftForUser> secretGifts = 
			getSpecificOrAllItemSecretGiftForUser(userId, ids);
	...
	public Collection<ItemSecretGiftForUser> getSpecificOrAllItemSecretGiftForUser(
		...
		try {
			...
			log.info(String.format(
				"getSpecificOrAllItemSecretGiftForUser() query=%s",
				query));

			secretGifts = this.jdbcTemplate
	...
	private static final class UserItemSecretGiftForClientMapper implements RowMapper<ItemSecretGiftForUser> {
		...
		public ItemSecretGiftForUser mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			isgfu.setSecsTillCollection(rs.getInt(DBConstants.ITEM_SECRET_GIFT_FOR_USER__SECS_UNTIL_COLLECTION));
		...
		public static List<String> getColumnsSelected() {
			if (null == columnsSelected) {
				...
				columnsSelected.add(DBConstants.ITEM_SECRET_GIFT_FOR_USER__SECS_UNTIL_COLLECTION);
