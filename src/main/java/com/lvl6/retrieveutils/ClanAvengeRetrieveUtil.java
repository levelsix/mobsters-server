...
//				"getUserIdToClanAvengeForClanId() query=%s", query));
//			
...
//				"could not retrieve clan help for clanAvengeId=%s", clanAvengeIds),
//				e);
//			clanAvenges =
//					new ArrayList<ClanAvenge>();
//		}
//		
//		return clanAvenges;
//	}
//	
//	public Map<String, List<ClanAvenge>> getUserIdToClanAvenge(
//		String clanId, String userId )
//	{
//		Map<String, List<ClanAvenge>> userIdToClanAvenges = null;
//		try {
...
//				equalityConditions.put(DBConstants.CLAN_AVENGE__USER_ID, userId);
//			}
...
//				return new HashMap<String, List<ClanAvenge>>();
//			}
//			
...
//			log.info(String.format(
//				"getUserIdToClanAvengeForClanId() query=%s", query));
//			List<ClanAvenge> chList = this.jdbcTemplate
//					.query(query, values.toArray(), new ClanAvengeForClientMapper());
//			
//			
//			userIdToClanAvenges = new HashMap<String, List<ClanAvenge>>();
//			for (ClanAvenge ch : chList) {
//				String userId2 = ch.getUserId();
//				
//				//base case: initializing list
//				if (!userIdToClanAvenges.containsKey(userId2)) {
//					userIdToClanAvenges.put(userId2, new ArrayList<ClanAvenge>());
//				}
//				
//				List<ClanAvenge> requests = userIdToClanAvenges.get(userId2);
//				requests.add(ch);
//			}
//		} catch (Exception e) {
//			log.error(String.format(
...
//				e);
//			userIdToClanAvenges =
//					new HashMap<String, List<ClanAvenge>>();
//		}
//		
//		return userIdToClanAvenges;
//	}
//	
