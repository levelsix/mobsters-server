...
public class QuestJobForUserRetrieveUtil {
	private static Logger log = LoggerFactory.getLogger(QuestJobForUserRetrieveUtil.class);
	...
	public QuestJobForUser getSpecificUserQuestJob(int userId, int questJobId) {
		...
		try {
			List<String> columnsToSelected = UserQuestJobForClientMapper.getColumnsSelected();
			
			Map<String, Object> equalityConditions = new HashMap<String, Object>();
			equalityConditions.put(DBConstants.QUEST_JOB_FOR_USER__USER_ID, userId);
			equalityConditions.put(DBConstants.QUEST_JOB_FOR_USER__QUEST_JOB_ID, questJobId);
			...
			qjfu = this.jdbcTemplate.queryForObject(query, new UserQuestJobForClientMapper());
		} catch (Exception e) {
	...
	public Map<Integer, QuestJobForUser> getQuestJobIdsToJobs(int userId,
		...
		try {
			...
			Map<String, Object> equalityConditions = new HashMap<String, Object>();
			equalityConditions.put(DBConstants.QUEST_JOB_FOR_USER__USER_ID, userId);
			equalityConditions.put(DBConstants.QUEST_JOB_FOR_USER__QUEST_ID, questId);
			String conditionDelimiter = getQueryConstructionUtil().getAnd();
	...
	private static final class UserQuestJobForClientMapper implements RowMapper<QuestJobForUser> {

		private static List<String> columnsSelected;

		public QuestJobForUser mapRow(ResultSet rs, int rowNum) throws SQLException {
...
//			qjfu.setUserId(rs.getInt(DBConstants.QUEST_JOB_FOR_USER__USER_ID));
			...
			qjfu.setQuestJobId(rs.getInt(DBConstants.QUEST_JOB_FOR_USER__QUEST_JOB_ID));
			qjfu.setComplete(rs.getBoolean(DBConstants.QUEST_JOB_FOR_USER__IS_COMPLETE));
			qjfu.setProgress(rs.getInt(DBConstants.QUEST_JOB_FOR_USER__PROGRESS));
			return qjfu;
		}        
...
//				columnsSelected.add(DBConstants.QUEST_JOB_FOR_USER__USER_ID);
				...
				columnsSelected.add(DBConstants.QUEST_JOB_FOR_USER__QUEST_JOB_ID);
				columnsSelected.add(DBConstants.QUEST_JOB_FOR_USER__IS_COMPLETE);
