...
public class GoldSaleRetrieveUtils {
				...
				if (rs != null) {
					try {
						...
						while (rs.next()) {  //should only be one
							...
							if (goldSale != null)
								goldSaleIdsToGoldSalesTemp.put(
										goldSale.getId(), goldSale);
						}
	...
	private static GoldSale convertRSRowToGoldSale(ResultSet rs)
		...
		GoldSale goldSale = new GoldSale(id, startDate, endDate,
				goldShoppeImageName, goldBarImageName, package1SaleIdentifier,
