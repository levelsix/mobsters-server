...
@Component @DependsOn("gameServer") public class BoosterDisplayItemRetrieveUtils {
  ...
  public static Map<Integer, BoosterDisplayItem> getBoosterDisplayItemIdsToBoosterDisplayItemsForBoosterPackId(int boosterPackId) {
    try {
...
//      }
  ...
  public static BoosterDisplayItem getBoosterDisplayItemForBoosterDisplayItemId(int boosterDisplayItemId) {
