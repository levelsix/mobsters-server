...
//    int attack = rs.getInt(DBConstants.);
    ...
    float costToFullyHealExponent = rs.getFloat(DBConstants.MONSTER_LEVEL_INFO__COST_TO_FULLY_HEAL_EXPONENT);
    int secsToFullyHeal = rs.getInt(DBConstants.MONSTER_LEVEL_INFO__SECS_TO_FULLY_HEAL);
    float secsToFullyHealExponent = rs.getFloat(DBConstants.MONSTER_LEVEL_INFO__SECS_TO_FULLY_HEAL_EXPONENT);
    ...
    MonsterLevelInfo srs = new MonsterLevelInfo(monsterId, level, hp,
    		...
    		teamCost, costToFullyHeal, costToFullyHealExponent, secsToFullyHeal, 
