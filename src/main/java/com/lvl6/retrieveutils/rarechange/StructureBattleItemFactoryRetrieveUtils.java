...
@Component @DependsOn("gameServer") public class StructureBattleItemFactoryRetrieveUtils {
  ...
  public static StructureBattleItemFactory getBattleItemFactoryForStructId(int structId) {
  ...
  public static StructureBattleItemFactory getUpgradedBattleItemFactoryForStructId(int structId) {
  	...
  	if (null != curStruct) {
  		...
  		StructureBattleItemFactory upgradedStruct = structIdsToBattleItemFactorys.get(successorStructId);
  		return upgradedStruct;
  	}
  	return null;
  }
  
  public static StructureBattleItemFactory getPredecessorBattleItemFactoryForStructId(int structId) {
  	...
  	if (null != curStruct) {
  		...
  		StructureBattleItemFactory predecessorStruct = structIdsToBattleItemFactorys.get(predecessorStructId);
   ...
   */
  private static StructureBattleItemFactory convertRSRowToBattleItemFactory(ResultSet rs) throws SQLException {
    int structId = rs.getInt(DBConstants.STRUCTURE_BATTLE_ITEM_FACTORY__STRUCT_ID);
    int powerLimit = rs.getInt(DBConstants.STRUCTURE_BATTLE_ITEM_FACTORY__POWER_LIMIT);
